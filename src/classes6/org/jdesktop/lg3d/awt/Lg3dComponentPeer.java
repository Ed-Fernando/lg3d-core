...
public class Lg3dComponentPeer implements java.awt.peer.ComponentPeer, SceneManagerListener {
    ...
    public Lg3dComponentPeer(java.awt.peer.ComponentPeer realPeer, java.awt.Component component, Toolkit osToolkit) {
        ...
        if (this instanceof SwingNodePeer) {
            ...
            if (debug)
                f = new NonLGJWindow();
            peerClass = "org.jdesktop.lg3d.awtpeer.HeavyWeightWindowPeerImpl";
        } else
...
//        logger.severe("Lg3dComponentPeer dispose() Not Implemented");
    ...
    public boolean requestFocus(Component lightweightChild, boolean temporary, boolean focusedWindowChangeAllowed, long time, sun.awt.CausedFocusEvent.Cause cause) {
        logger.warning("requestFocus not fully implemented caused by "+cause);
//        System.err.println("*****LightweightChild "+lightweightChild);
//        System.err.println("+++++AwtComponent "+awtComponent);
        
        // The call to shouldNativelyFocusHeavyweight stops the delivery of key events.
//        int result = keyboardFocusManager.shouldNativelyFocusHeavyweight(awtComponent, lightweightChild, temporary, focusedWindowChangeAllowed, time, cause);
//        System.err.println("call result "+result);
        //keyboardFocusManager.setGlobalFocusOwner(lightweightChild);
        
        // TODO Not sure if this is sufficient/correct.
        
        FocusEvent fg = new CausedFocusEvent(lightweightChild, FocusEvent.FOCUS_GAINED, false, null, cause);
        awtComponent.dispatchEvent(fg);
