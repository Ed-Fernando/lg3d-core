 ...
 *
 * $RCSfile: BackgroundSwayer.java,v $
 *
...
class BackgroundSwayer extends Component3D {
    ...
    public BackgroundSwayer(Component3D sensitiveArea, float dist1, float dist2, 
            float level) 
    {
        setName("BackgroundSwayer");
        /*
         * this -> rotY -> rotX -> rootForChild [-> children]
         */
        rootForChild = new Component3D();
        rootForChild.setTranslation(0.0f, 0.0f, dist1);
        
        NaturalMotionAnimation nmax = new NaturalMotionAnimation(10000);
        ...
        NaturalMotionAnimation nmay = new NaturalMotionAnimation(10000);
        nmay.setRotationAngleSmoother(new SpringFloatSmoother());
        rotY = new Component3D();
        rotY.setAnimation(nmay);
        rotY.setTranslation(0.0f, 0.0f, dist2);
