 ...
 *
 *   $RCSfile: EditMenuGroupAction.java,v $
 *   
...
public class EditMenuGroupAction implements ActionNoArg {
    
    private static Logger logger = Logger.getLogger("lg.startmenu");
    
    private MenuGroup editGroup;
    
    public EditMenuGroupAction(MenuGroup editGroup) {
        this.editGroup= editGroup;
    }
    
    public void performAction(LgEventSource source) {
        logger.log(Level.FINE, "Editing group " + editGroup);
        AppConnectorPrivate.getAppConnector().postEvent(new EditingMenuGroupEvent(editGroup), null);
    }
