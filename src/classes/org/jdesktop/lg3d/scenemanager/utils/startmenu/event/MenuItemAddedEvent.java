 ...
 *                                                                         *
 *   $RCSfile: MenuItemAddedEvent.java,v $                                                             *
 *                                                                         *
...
public class MenuItemAddedEvent extends LgEvent {
    
    private MenuItem item;
    
    private MenuGroup parentGroup;
    
    public MenuItemAddedEvent(MenuItem item, MenuGroup parentGroup) {
        this.item= item;
    ...
    public MenuGroup getParentGroup() {
        return parentGroup;
    }
