 ...
 *                                                                         *
 *   $RCSfile: MenuGroupLinkAddedEvent.java,v $                                                             *
 *                                                                         *
...
public class MenuGroupLinkAddedEvent extends LgEvent {
    
    private MenuGroup localGroup;
    
    private MenuGroup remoteGroup;
    
    public MenuGroupLinkAddedEvent(MenuGroup localGroup, MenuGroup remoteGroup) {
