 ...
 *                                                                         *
 *   $RCSfile: EditingMenuGroupEvent.java,v $                                                             *
 *                                                                         *
...
public class EditingMenuGroupEvent extends LgEvent {
    
    private MenuGroup group;
    
    public EditingMenuGroupEvent(MenuGroup group) {
        this.group= group;
    }
