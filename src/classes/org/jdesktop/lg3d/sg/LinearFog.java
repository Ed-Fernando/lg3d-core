...
public class LinearFog extends Fog {
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"LinearFog");    
    }
    ...
    public void setFrontDistance(float frontDistance) {
    	((LinearFogWrapper)wrapped).setFrontDistance(frontDistance);
    }
    ...
    public float getFrontDistance() {
    	return ((LinearFogWrapper)wrapped).getFrontDistance();
    }
    ...
    public void setBackDistance(float backDistance) {
    	((LinearFogWrapper)wrapped).setBackDistance(backDistance);
    }
    ...
    public float getBackDistance() {
    	return ((LinearFogWrapper)wrapped).getBackDistance();
    }
