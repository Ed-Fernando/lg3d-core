...
public class TextureAttributes extends NodeComponent {
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"TextureAttributes");
	...
	((TextureAttributesWrapper)wrapped).setTextureMode( textureMode );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getTextureMode();
    }
	...
	((TextureAttributesWrapper)wrapped).setTextureBlendColor( textureBlendColor );
    }
	...
	((TextureAttributesWrapper)wrapped).setTextureBlendColor( r,g,b,a );
    }
	...
	((TextureAttributesWrapper)wrapped).getTextureBlendColor( textureBlendColor );
    }
	...
	((TextureAttributesWrapper)wrapped).setTextureTransform( (Transform3DWrapper)transform.wrapped );
    }
	...
	((TextureAttributesWrapper)wrapped).getTextureTransform( (Transform3DWrapper)transform.wrapped );
    }
	...
	((TextureAttributesWrapper)wrapped).setPerspectiveCorrectionMode( mode );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getPerspectiveCorrectionMode();
    }
	...
	((TextureAttributesWrapper)wrapped).setTextureColorTable( table );
    }
    ...
    public void getTextureColorTable(int[][] table) {
        ((TextureAttributesWrapper)wrapped).getTextureColorTable( table );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getNumTextureColorTableComponents();
    }
	...
	return ((TextureAttributesWrapper)wrapped).getTextureColorTableSize();
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineRgbMode( combineMode );
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineAlphaMode( combineMode );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineRgbMode();
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineAlphaMode();
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineRgbSource( index, src );
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineAlphaSource( index, src );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineRgbSource( index );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineAlphaSource( index );
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineRgbFunction( index, function );
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineAlphaFunction( index, function );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineRgbFunction( index );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineAlphaFunction( index );
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineRgbScale( scale );
    }
	...
	((TextureAttributesWrapper)wrapped).setCombineAlphaScale( scale );
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineRgbScale();
    }
	...
	return ((TextureAttributesWrapper)wrapped).getCombineAlphaScale();
    }
