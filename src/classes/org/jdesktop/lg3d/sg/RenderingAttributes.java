...
//    public static final int ROP_SET = 0xF;
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"RenderingAttributes");
    }
	...
	((RenderingAttributesWrapper)wrapped).setDepthBufferEnable( state );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getDepthBufferEnable();
    }
	...
	((RenderingAttributesWrapper)wrapped).setDepthBufferWriteEnable( state );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getDepthBufferWriteEnable();
    }
	...
	((RenderingAttributesWrapper)wrapped).setAlphaTestValue( value );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getAlphaTestValue();
    }
	...
	((RenderingAttributesWrapper)wrapped).setAlphaTestFunction( function );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getAlphaTestFunction();
    }
	...
	((RenderingAttributesWrapper)wrapped).setVisible( visible );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getVisible();
    }
	...
	((RenderingAttributesWrapper)wrapped).setIgnoreVertexColors( ignoreVertexColors );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getIgnoreVertexColors();
    }
	...
	((RenderingAttributesWrapper)wrapped).setRasterOpEnable( rasterOpEnable );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getRasterOpEnable();
    }
	...
	((RenderingAttributesWrapper)wrapped).setRasterOp( rasterOp );
    }
	...
	return ((RenderingAttributesWrapper)wrapped).getRasterOp();
    }
