...
public abstract class GeometryArray extends Geometry {
  ...
  public static final int TEXTURE_COORDINATE_2 = 0x20;
	...
	return ((GeometryArrayWrapper)wrapped).getVertexCount();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getVertexFormat();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getTexCoordSetCount();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getTexCoordSetMapLength();
    }
    ...
    public void getTexCoordSetMap(int[] texCoordSetMap) {
        ((GeometryArrayWrapper)wrapped).getTexCoordSetMap(texCoordSetMap);
    }
	...
	((GeometryArrayWrapper)wrapped).setValidVertexCount(validVertexCount);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getValidVertexCount();
    }
	...
	((GeometryArrayWrapper)wrapped).setInitialVertexIndex(initialVertexIndex);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getInitialVertexIndex();
    }
  ...
  public void setCoordinate(int index, float coordinate[]) {
        ((GeometryArrayWrapper)wrapped).setCoordinate(index, coordinate);
  }
  ...
  public void setCoordinates(int index, float coordinates[]) {
    ((GeometryArrayWrapper)wrapped).setCoordinates(index, coordinates);
  }
  ...
  public void setColor(int index, float color[]) {
    ((GeometryArrayWrapper)wrapped).setColor(index, color);
  }
  ...
  public void setColors(int index, float colors[]) {
    ((GeometryArrayWrapper)wrapped).setColors(index, colors);
  }
  ...
  public void setColors(int index, float colors[],
				   int start, int length) {
    ((GeometryArrayWrapper)wrapped).setColors(index, colors, start,
                                                length);
  }
  ...
  public void setNormal(int index, float normal[]) {
    ((GeometryArrayWrapper)wrapped).setNormal(index, normal);
  }
  ...
  public void setNormals(int index, float normals[]) {
    ((GeometryArrayWrapper)wrapped).setNormals(index, normals);
  }
  ...
  public void setNormals(int index, float normals[],
				   int start, int length) {
    ((GeometryArrayWrapper)wrapped).setNormals(index, normals, start,                                                    length);
  }
  ...
  public void setNormals(int index, Vector3f normals[],
	...
	((GeometryArrayWrapper)wrapped).setTextureCoordinates(
	...
	((GeometryArrayWrapper)wrapped).setTextureCoordinate( index, texCoord);
    }
	...
	((GeometryArrayWrapper)wrapped).setTextureCoordinate(
  ...
  public void getCoordinate(int index, float coordinate[]) {
    ((GeometryArrayWrapper)wrapped).getCoordinate(index, coordinate);
  }
  ...
  public void getCoordinates(int index, float coordinates[]) {
    ((GeometryArrayWrapper)wrapped).getCoordinates(index, coordinates);
  }
  ...
  public void getColor(int index, float color[]) {
    ((GeometryArrayWrapper)wrapped).getColor(index, color);
  }
  ...
  public void getColors(int index, float colors[]) {
    ((GeometryArrayWrapper)wrapped).getColors(index, colors);
  }
  ...
  public void getNormal(int index, float normal[]) {
    ((GeometryArrayWrapper)wrapped).getNormal(index, normal);
  }
  ...
  public void getNormals(int index, float normals[]) {
    ((GeometryArrayWrapper)wrapped).getNormals(index, normals);
  }
  ...
  public void getNormals(int index, Vector3f normals[]) {
    ...
    public void getTextureCoordinate(int texCoordSet,
				     int index, float texCoord[]) {
	((GeometryArrayWrapper)wrapped).getTextureCoordinate(
				texCoordSet, index, texCoord);
    }
    ...
    public void getTextureCoordinates(int texCoordSet,
				      int index, float texCoords[]) {
	((GeometryArrayWrapper)wrapped).getTextureCoordinates(
				texCoordSet, index, texCoords);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getInitialCoordIndex();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getInitialColorIndex();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getInitialNormalIndex();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getInitialTexCoordIndex(
							texCoordSet);
    }
	...
	((GeometryArrayWrapper)wrapped).setCoordRefFloat(coords);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getCoordRefFloat();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getCoordRef3f();
    }
	...
	((GeometryArrayWrapper)wrapped).setColorRefFloat(colors);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getColorRefFloat();
    }
	...
	((GeometryArrayWrapper)wrapped).setColorRef3f(colors);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getColorRef3f();
    }
	...
	((GeometryArrayWrapper)wrapped).setNormalRefFloat(normals);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getNormalRefFloat();
    }
	...
	return ((GeometryArrayWrapper)wrapped).getNormalRef3f();
    }
	...
	((GeometryArrayWrapper)wrapped).setTexCoordRefFloat(
	...
	return ((GeometryArrayWrapper)wrapped).getTexCoordRefFloat(
							texCoordSet);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getTexCoordRef2f(
							texCoordSet);
    }
	...
	((GeometryArrayWrapper)wrapped).setInterleavedVertices(vertexData);
    }
	...
	return ((GeometryArrayWrapper)wrapped).getInterleavedVertices();
    }
}
