...
public abstract class Node extends SceneGraphObject {
    ...
    ENABLE_PICK_REPORTING = javax.media.j3d.Node.ENABLE_PICK_REPORTING;
     ...
     */  
    public static final int
    ENABLE_COLLISION_REPORTING = javax.media.j3d.Node.ENABLE_COLLISION_REPORTING;
     ...
     */
    public static final int
    ALLOW_BOUNDS_READ = javax.media.j3d.Node.ALLOW_BOUNDS_READ;
     ...
     */
    public static final int
    ALLOW_BOUNDS_WRITE = javax.media.j3d.Node.ALLOW_BOUNDS_WRITE;

    /**
     * Specifies that this Node allows reading its pickability state.
     */
    public static final int
    ALLOW_PICKABLE_READ = javax.media.j3d.Node.ALLOW_PICKABLE_READ;

    /**
     * Specifies that this Node allows write access its pickability state.
     */
    public static final int
    ALLOW_PICKABLE_WRITE = javax.media.j3d.Node.ALLOW_PICKABLE_WRITE;

    /**
     * Specifies that this Node allows reading its collidability state.
     */
    public static final int
    ALLOW_COLLIDABLE_READ = javax.media.j3d.Node.ALLOW_COLLIDABLE_READ;

    /**
     * Specifies that this Node allows write access its collidability state.
     */
    public static final int
    ALLOW_COLLIDABLE_WRITE = javax.media.j3d.Node.ALLOW_COLLIDABLE_WRITE;
     ...
     */
    public static final int
    ALLOW_AUTO_COMPUTE_BOUNDS_READ = javax.media.j3d.Node.ALLOW_AUTO_COMPUTE_BOUNDS_READ;
     ...
     */
    public static final int
    ALLOW_AUTO_COMPUTE_BOUNDS_WRITE = javax.media.j3d.Node.ALLOW_AUTO_COMPUTE_BOUNDS_WRITE;
     ...
     */
    public static final int
    ALLOW_LOCAL_TO_VWORLD_READ = javax.media.j3d.Node.ALLOW_LOCAL_TO_VWORLD_READ;
    
    /**
     * Specifies that this Node allows read access to its parent Group node.
     */
    public static final int
    ALLOW_PARENT_READ = javax.media.j3d.Node.ALLOW_PARENT_READ;
    ...
    public Node getParent() {
        NodeWrapper ret = ((NodeWrapper)wrapped).getParent();
        if (ret == null) {
            return null;
        }
        return (Node)ret.getUserData();
    }
	...
	((NodeWrapper)wrapped).setBounds( bounds.wrapped );
    ...
    public Bounds getBounds() {
        //return (Bounds)((NodeWrapper)wrapped).getBounds().getUserData();
	...
	((NodeWrapper)wrapped).setBoundsAutoCompute(autoCompute);
    }
	...
	return ((NodeWrapper)wrapped).getBoundsAutoCompute();
    }
	...
	((NodeWrapper)wrapped).getLocalToVworld(t.wrapped);
    }
	...
	((NodeWrapper)wrapped).getLocalToVworld(path.wrapped,t.wrapped);
    }
	...
	((NodeWrapper)wrapped).setPickable( pickable );
    }
	...
	return ((NodeWrapper)wrapped).getPickable();
    }
