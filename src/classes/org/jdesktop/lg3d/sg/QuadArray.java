...
public class QuadArray extends GeometryArray {
    ...
    public QuadArray(int vertexCount, int vertexFormat) {
        assert(this.getClass()==QuadArray.class);
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"QuadArray", new Class[] {Integer.TYPE, Integer.TYPE}, new Object[] { new Integer(vertexCount), new Integer( vertexFormat ) } );
    }
    ...
    public QuadArray(int vertexCount,
		     ...
		     int[] texCoordSetMap) {
        assert(this.getClass()==QuadArray.class);
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"QuadArray",
