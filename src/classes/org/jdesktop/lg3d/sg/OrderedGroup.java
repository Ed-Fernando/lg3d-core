...
/**
 * Not currently supported in LG3d
 */
class OrderedGroup extends Group {
    ...
    protected void createWrapped() {
        wrapped = instantiate("OrderedGroup");
    }
    ...
    public void setChildIndexOrder(int[] childIndexOrder) {
        ((OrderedGroupWrapper)wrapped).setChildIndexOrder(childIndexOrder);
    }
    ...
    public int[] getChildIndexOrder() {
        return ((OrderedGroupWrapper)wrapped).getChildIndexOrder();
    }
    ...
    public void addChild(Node child, int[] childIndexOrder) {
        ((OrderedGroupWrapper)wrapped).addChild((NodeWrapper)child.wrapped, childIndexOrder);
    }
