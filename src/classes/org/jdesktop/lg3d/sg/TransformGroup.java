...
public class TransformGroup extends Group {
  ...
  public static final int
    ...
    public TransformGroup() {
        ...
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"TransformGroup" );
    }
	...
	//wrapped = new javax.media.j3d.TransformGroup( t1.wrapped );
        //wrapped.setUserData( this );
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"TransformGroup", new Class[] {Transform3DWrapper.class}, new Object[] { t1.wrapped } );
    }
	...
	((TransformGroupWrapper)wrapped).setTransform( t1.wrapped );
    }
   ...
   */
    public void getTransform(Transform3D t1) {
        ((TransformGroupWrapper)wrapped).getTransform( t1.wrapped );
    }
