...
public class Alpha extends NodeComponent {
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"Alpha" );
    }
	...
	((AlphaWrapper)wrapped).pause( time );
    }
	...
	return ((AlphaWrapper)wrapped).isPaused();
    }
	...
	return ((AlphaWrapper)wrapped).getPauseTime();
    }
     ...
     */
    public float value() {
	return ((AlphaWrapper)wrapped).value();
    }
    ...
    public float value(long atTime) {
        return ((AlphaWrapper)wrapped).value(atTime);
    }
	...
	return ((AlphaWrapper)wrapped).getStartTime();
    }
	...
	((AlphaWrapper)wrapped).setStartTime( startTime );
    }
	...
	return ((AlphaWrapper)wrapped).getLoopCount();
    }
	...
	((AlphaWrapper)wrapped).setLoopCount( loopCount );
    }
    ...
    /**
      ...
      */
    public int getMode() {
	return ((AlphaWrapper)wrapped).getMode();
    }
	...
	((AlphaWrapper)wrapped).setMode(mode);
    }
	...
	return ((AlphaWrapper)wrapped).getTriggerTime();
    }
	...
	((AlphaWrapper)wrapped).setTriggerTime( triggerTime );
    }
	...
	return ((AlphaWrapper)wrapped).getPhaseDelayDuration();
    }
	...
	((AlphaWrapper)wrapped).setPhaseDelayDuration( phaseDelayDuration );
    }
	...
	return ((AlphaWrapper)wrapped).getIncreasingAlphaDuration();
    }
	...
	((AlphaWrapper)wrapped).setIncreasingAlphaDuration( increasingAlphaDuration );
    }
	...
	return ((AlphaWrapper)wrapped).getIncreasingAlphaRampDuration();
    }
	...
	((AlphaWrapper)wrapped).setIncreasingAlphaRampDuration( increasingAlphaRampDuration );
    }
	...
	return ((AlphaWrapper)wrapped).getAlphaAtOneDuration();
    }
	...
	((AlphaWrapper)wrapped).setAlphaAtOneDuration( alphaAtOneDuration );
    }
	...
	return ((AlphaWrapper)wrapped).getDecreasingAlphaDuration();
    }
	...
	((AlphaWrapper)wrapped).setDecreasingAlphaDuration( decreasingAlphaDuration );
    }
	...
	return ((AlphaWrapper)wrapped).getDecreasingAlphaRampDuration();
    }
	...
	((AlphaWrapper)wrapped).setDecreasingAlphaRampDuration( decreasingAlphaRampDuration );
    }
	...
	return ((AlphaWrapper)wrapped).getAlphaAtZeroDuration();
    }
	...
	((AlphaWrapper)wrapped).setAlphaAtZeroDuration( alphaAtZeroDuration );
    }
	...
	return ((AlphaWrapper)wrapped).finished();
    }
}
