...
import org.jdesktop.lg3d.sg.internal.wrapper.ShaderAttributeBindingWrapper;
...
public class ShaderAttributeBinding extends ShaderAttribute {
	...
	return ((ShaderAttributeBindingWrapper)wrapped).getJ3DAttributeName();
    }
