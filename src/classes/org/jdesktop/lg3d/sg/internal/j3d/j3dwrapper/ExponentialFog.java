...
public class ExponentialFog extends Fog implements ExponentialFogWrapper {
    ...
    protected void createWrapped() {
        wrapped = new javax.media.j3d.ExponentialFog();
    ...
    public void setDensity(float density) {
        ((javax.media.j3d.ExponentialFog)wrapped).setDensity(density);
    }
    ...
    public float getDensity() {
        return ((javax.media.j3d.ExponentialFog)wrapped).getDensity();
    }
