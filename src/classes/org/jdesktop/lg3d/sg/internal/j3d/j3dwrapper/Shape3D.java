...
public class Shape3D extends Leaf implements Shape3DWrapper {
    ...
    protected void createWrapped() {
        wrapped = new javax.media.j3d.Shape3D();
	...
	((javax.media.j3d.Shape3D)wrapped).setGeometry((javax.media.j3d.Geometry)((Geometry)geometry).wrapped);
    }
	...
	return (Geometry)((javax.media.j3d.Shape3D)wrapped).getGeometry().getUserData();
    }
	...
	((javax.media.j3d.Shape3D)wrapped).setGeometry((javax.media.j3d.Geometry)((Geometry)geometry).wrapped, index);
    }
	...
	return (Geometry)((javax.media.j3d.Shape3D)wrapped).getGeometry(index).getUserData();
    }
	...
	((javax.media.j3d.Shape3D)wrapped).insertGeometry( (javax.media.j3d.Geometry)((Geometry)geometry).wrapped, index);
    }
	...
	((javax.media.j3d.Shape3D)wrapped).removeGeometry(index);
    }
	...
	((javax.media.j3d.Shape3D)wrapped).addGeometry((javax.media.j3d.Geometry)((Geometry)geometry).wrapped);
    }
	...
	return ((javax.media.j3d.Shape3D)wrapped).numGeometries();
    }
	...
	return ((javax.media.j3d.Shape3D)wrapped).indexOfGeometry(((javax.media.j3d.Geometry)((Geometry)geometry).wrapped));
    }
	...
	((javax.media.j3d.Shape3D)wrapped).removeGeometry(((javax.media.j3d.Geometry)((Geometry)geometry).wrapped));
    }
	...
	((javax.media.j3d.Shape3D)wrapped).removeAllGeometries();
    }
    ...
    public void setAppearance(AppearanceWrapper appearance) {
        //System.out.println("SEVERE Shape3D.setAppearance "+((Appearance)appearance).wrapped);
	((javax.media.j3d.Shape3D)wrapped).setAppearance((javax.media.j3d.Appearance)((Appearance)appearance).wrapped);
    }
     ...
     */
     public AppearanceWrapper getAppearance() {
        javax.media.j3d.Appearance app = ((javax.media.j3d.Shape3D)wrapped).getAppearance();
        if (app==null)
            return null;
