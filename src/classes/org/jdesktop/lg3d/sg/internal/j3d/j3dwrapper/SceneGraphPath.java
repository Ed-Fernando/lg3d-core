...
public class SceneGraphPath implements SceneGraphPathWrapper {
    ...
    javax.media.j3d.SceneGraphPath wrapped;
     ...
     */
    public final void set(SceneGraphPathWrapper newPathIn) {
        SceneGraphPath newPath = (SceneGraphPath)newPathIn;
     ...
     */
    public boolean equals(SceneGraphPathWrapper testPathIn) {
        SceneGraphPath testPath = (SceneGraphPath)testPathIn;
	boolean result = true;
        try {
   ...
   /**
    ...
    public final boolean isSamePath(SceneGraphPathWrapper testPath) {
         return wrapped.isSamePath( ((SceneGraphPath)testPath).wrapped );
    }
