...
public abstract class GeometryArray extends Geometry implements GeometryArrayWrapper {
  ...
  public static final int TEXTURE_COORDINATE_2 = 0x20;
	...
	((javax.media.j3d.GeometryArray)wrapped).setValidVertexCount(validVertexCount);
    }
	...
	((javax.media.j3d.GeometryArray)wrapped).setInitialVertexIndex(initialVertexIndex);
    }
  ...
  public void setCoordinate(int index, float coordinate[]) {
    ((javax.media.j3d.GeometryArray)wrapped).setCoordinate(index, coordinate);
  }
  ...
  public void setCoordinates(int index, float coordinates[]) {
    ((javax.media.j3d.GeometryArray)wrapped).setCoordinates(index, coordinates);
//    try {
...
//    }
  ...
  public void setColor(int index, float color[]) {
    ((javax.media.j3d.GeometryArray)wrapped).setColor(index, color);
  }
  ...
  public void setColors(int index, float colors[]) {
    ((javax.media.j3d.GeometryArray)wrapped).setColors(index, colors);
//    try {
...
//    }
  ...
  public void setColors(int index, float colors[],
				   int start, int length) {
    ((javax.media.j3d.GeometryArray)wrapped).setColors(index, colors, start,
                                                length);
  }
  ...
  public void setNormal(int index, float normal[]) {
    ((javax.media.j3d.GeometryArray)wrapped).setNormal(index, normal);
  }
  ...
  public void setNormals(int index, float normals[]) {
    ((javax.media.j3d.GeometryArray)wrapped).setNormals(index, normals);
  }
  ...
  public void setNormals(int index, float normals[],
				   int start, int length) {
    ((javax.media.j3d.GeometryArray)wrapped).setNormals(index, normals, start,                                                    length);
  }
  ...
  public void setNormals(int index, Vector3f normals[],
	...
	((javax.media.j3d.GeometryArray)wrapped).setTextureCoordinates(
	...
	((javax.media.j3d.GeometryArray)wrapped).setTextureCoordinate( index, texCoord);
    }
	...
	((javax.media.j3d.GeometryArray)wrapped).setTextureCoordinate(
		texCoordSet, index, texCoord);
    }
  ...
  public void getNormals(int index, Vector3f normals[]) {
    ...
    public void getTextureCoordinates(int texCoordSet,
				      int index, float texCoords[]) {
	((javax.media.j3d.GeometryArray)wrapped).getTextureCoordinates(
				texCoordSet, index, texCoords);
    }
	...
	((javax.media.j3d.GeometryArray)wrapped).setCoordRefFloat(coords);
	...
	((javax.media.j3d.GeometryArray)wrapped).setColorRefFloat(colors);
    }
	...
	((javax.media.j3d.GeometryArray)wrapped).setColorRef3f(colors);
    }
	...
	((javax.media.j3d.GeometryArray)wrapped).setNormalRefFloat(normals);
    }
	...
	((javax.media.j3d.GeometryArray)wrapped).setTexCoordRefFloat(
	...
	((javax.media.j3d.GeometryArray)wrapped).setInterleavedVertices(vertexData);
    }
