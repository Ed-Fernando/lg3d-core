...
import org.jdesktop.lg3d.sg.internal.wrapper.IndexedTriangleStripArrayWrapper;
...
public class IndexedTriangleStripArray extends IndexedGeometryStripArray implements IndexedTriangleStripArrayWrapper {
    ...
    public IndexedTriangleStripArray(int vertexCount,
        ...
        assert(this.getClass()==IndexedTriangleStripArray.class);
	wrapped = new javax.media.j3d.IndexedTriangleStripArray(vertexCount,
				      vertexFormat,
				      texCoordSetCount,
				      texCoordSetMap,
				      indexCount,
