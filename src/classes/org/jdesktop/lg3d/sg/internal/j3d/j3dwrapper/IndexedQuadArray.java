...
import org.jdesktop.lg3d.sg.internal.wrapper.IndexedQuadArrayWrapper;
...
public class IndexedQuadArray extends IndexedGeometryArray implements IndexedQuadArrayWrapper {
    ...
    */
    ...
    public IndexedQuadArray(int vertexCount,
			     ...
			     int[] texCoordSetMap,
			     int indexCount) {
        assert(this.getClass()==IndexedQuadArray.class);
	wrapped = new javax.media.j3d.IndexedQuadArray(vertexCount,
			      vertexFormat,
			      texCoordSetCount,
			      texCoordSetMap,
			      indexCount);
