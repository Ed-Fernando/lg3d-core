...
public abstract class IndexedGeometryStripArray extends IndexedGeometryArray implements IndexedGeometryStripArrayWrapper {
   ...
   */
	...
	return ((javax.media.j3d.IndexedGeometryStripArray)wrapped).getNumStrips();
    }
    ...
    public void setStripIndexCounts(int[] stripIndexCounts) {
        ((javax.media.j3d.IndexedGeometryStripArray)wrapped).setStripIndexCounts(stripIndexCounts);
    }
    ...
    public void getStripIndexCounts(int[] stripIndexCounts) {
        ((javax.media.j3d.IndexedGeometryStripArray)wrapped).getStripIndexCounts(stripIndexCounts);
    }
