...
public class BranchGroup extends Group implements BranchGroupWrapper {
   ...
   */
    ...
    protected void createWrapped() {
        wrapped = new javax.media.j3d.BranchGroup();
   ...
   */
    public void detach() {
       ((javax.media.j3d.BranchGroup)wrapped).detach();
  }
   ...
   */
    public SceneGraphPathWrapper[] pickAll( PickShapeWrapper pickShape ) {
        javax.media.j3d.SceneGraphPath[] j3dSGP = ((javax.media.j3d.BranchGroup)wrapped).pickAll( (javax.media.j3d.PickShape)((PickShape)pickShape).wrapped );
        if (j3dSGP==null)
            return null;
        SceneGraphPathWrapper[] ret = new SceneGraphPath[j3dSGP.length];
   ...
   */
    public SceneGraphPathWrapper[] pickAllSorted( PickShapeWrapper pickShape ) {
        javax.media.j3d.SceneGraphPath[] j3dSGP = ((javax.media.j3d.BranchGroup)wrapped).pickAllSorted( (javax.media.j3d.PickShape)((PickShape)pickShape).wrapped );
        if (j3dSGP==null)
            return null;
   ...
   */
    public SceneGraphPathWrapper pickClosest( PickShapeWrapper pickShape ) {
        return new SceneGraphPath(((javax.media.j3d.BranchGroup)wrapped).pickClosest((javax.media.j3d.PickShape)((PickShape)pickShape).wrapped ));
    }
   ...
   */
    public SceneGraphPathWrapper pickAny( PickShapeWrapper pickShape ) {
        return new SceneGraphPath(((javax.media.j3d.BranchGroup)wrapped).pickAny( (javax.media.j3d.PickShape)((PickShape)pickShape).wrapped ));
    }
