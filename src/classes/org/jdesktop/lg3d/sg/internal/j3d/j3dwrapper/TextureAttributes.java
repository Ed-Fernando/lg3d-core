...
public class TextureAttributes extends NodeComponent implements TextureAttributesWrapper {
    ...
    protected void createWrapped() {
        wrapped = new javax.media.j3d.TextureAttributes();
     ...
     */
    public TextureAttributes(int textureMode, Transform3DWrapper transform,
	...
	((javax.media.j3d.TextureAttributes)wrapped).setTextureMode( textureMode );
    }
	...
	return ((javax.media.j3d.TextureAttributes)wrapped).getTextureMode();
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setTextureBlendColor( textureBlendColor );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setTextureBlendColor( r,g,b,a );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).getTextureBlendColor( textureBlendColor );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setTextureTransform( (javax.media.j3d.Transform3D)((Transform3D)transform).wrapped );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).getTextureTransform( (javax.media.j3d.Transform3D)((Transform3D)transform).wrapped );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setPerspectiveCorrectionMode( mode );
    }
	...
	return ((javax.media.j3d.TextureAttributes)wrapped).getPerspectiveCorrectionMode();
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setTextureColorTable( table );
    }
	...
	return ((javax.media.j3d.TextureAttributes)wrapped).getNumTextureColorTableComponents();
    }
	...
	return ((javax.media.j3d.TextureAttributes)wrapped).getTextureColorTableSize();
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineRgbMode( combineMode );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineAlphaMode( combineMode );
    }
	...
	return ((javax.media.j3d.TextureAttributes)wrapped).getCombineRgbMode();
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineRgbSource( index, src );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineAlphaSource( index, src );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineRgbFunction( index, function );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineAlphaFunction( index, function );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineRgbScale( scale );
    }
	...
	((javax.media.j3d.TextureAttributes)wrapped).setCombineAlphaScale( scale );
    }
	...
	return ((javax.media.j3d.TextureAttributes)wrapped).getCombineRgbScale();
    }
	...
	return ((javax.media.j3d.TextureAttributes)wrapped).getCombineAlphaScale();
    }
