...
//        wrapped = new javax.media.j3d.ImageComponent2D( format, width, height );
        wrapped = new org.jdesktop.lg3d.displayserver.nativewindow.J3dNativeWindowImageComponent2D(
                                format,
                                width,
                                height ); 
    ...
    public ImageComponent2D(int		format,
			    ...
			    boolean	yUp) {
        assert(this.getClass()==ImageComponent2D.class);
//         wrapped = new javax.media.j3d.ImageComponent2D( format, 
//                                                         width, 
//                                                         height,
//                                                         byReference,
//                                                         yUp );
...
//                                                        yUp );
    ...
    public void set(BufferedImage image) {
        ((javax.media.j3d.ImageComponent2D)wrapped).set( image );
    }
    ...
    public void setSubImage(RenderedImage image, int width, int height,
        ...
        ((javax.media.j3d.ImageComponent2D)wrapped).setSubImage( image,
                                                                 width,
                                                                 height,
                                                                 srcX,
                                                                 srcY,
...
//    }
     ...
     */
//    public static interface Updater extends ImageComponent2D.Updater {
//	/**
//	 * Updates image data that is accessed by reference.
