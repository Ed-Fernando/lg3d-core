...
public class ColoringAttributes extends NodeComponent implements ColoringAttributesWrapper {
	...
	wrapped = new javax.media.j3d.ColoringAttributes();
	...
	((javax.media.j3d.ColoringAttributes)wrapped).setColor( color );
    }
	...
	((javax.media.j3d.ColoringAttributes)wrapped).setColor( r,g,b );
    }
	...
	((javax.media.j3d.ColoringAttributes)wrapped).getColor(color);
    }
	...
	((javax.media.j3d.ColoringAttributes)wrapped).setShadeModel( shadeModel );
    }
	...
	return ((javax.media.j3d.ColoringAttributes)wrapped).getShadeModel();
    }
