...
public class Switch extends Group implements SwitchWrapper {
    ...
    protected void createWrapped() {
        wrapped = new javax.media.j3d.Switch();
	...
	((javax.media.j3d.Switch)wrapped).setWhichChild(child);
    }
	...
	return ((javax.media.j3d.Switch)wrapped).getWhichChild();
    }
	...
	((javax.media.j3d.Switch)wrapped).setChildMask(childMask);
    }
	...
	return ((javax.media.j3d.Switch)wrapped).getChildMask();
    }
	...
	javax.media.j3d.Node j3dNode = ((javax.media.j3d.Switch)wrapped).currentChild();
        if (j3dNode==null)
            return null;
        else
