...
public abstract class Bounds implements BoundsWrapper {
    ...
    javax.media.j3d.Bounds wrapped;    
    org.jdesktop.lg3d.sg.Bounds userData;
     ...
     *
     */    
    protected static final WeakHashMap<javax.media.j3d.Bounds, Bounds> reverseLookup = new WeakHashMap();
    ...
    /**
     * Called by the default constructor to initialise the wrapper
     */
    ...
    /**  
     * Store a reference to the lg bounds in the wrapped bounds object  
     */    
    ...
    /**   
     * Get the lg bounds that this wrapped oject maps to  
     */    
    public org.jdesktop.lg3d.sg.Bounds getUserData() {       
        return userData;       
    }
    
    void changeWrapped(javax.media.j3d.Bounds newBounds) {
        reverseLookup.remove(wrapped);
        wrapped = newBounds;
