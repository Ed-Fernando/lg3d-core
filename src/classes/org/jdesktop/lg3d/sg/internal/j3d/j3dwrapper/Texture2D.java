...
public class Texture2D extends Texture implements Texture2DWrapper {
   ...
   */
    public Texture2D(
	    ...
	    int		width,
	    int		height){
        assert(this.getClass()==Texture2D.class);
    ...
    public Texture2D(int          mipMapMode,
                   ...
                   int          boundaryWidth) {
        assert(this.getClass()==Texture2D.class);
	wrapped = new javax.media.j3d.Texture2D(mipMapMode, format, width, height, boundaryWidth);
        wrapped.setUserData( this );
    }
	...
	((javax.media.j3d.Texture2D)wrapped).setMagFilter( magFilter );
    }
    ...
    public void setDetailImage(ImageComponent2DWrapper detailTexture) {
        ((javax.media.j3d.Texture2D)wrapped).setDetailImage( (javax.media.j3d.ImageComponent2D)((ImageComponent2D)detailTexture).wrapped );
    }
    ...
    public ImageComponent2DWrapper getDetailImage() {
        return (ImageComponent2DWrapper)((javax.media.j3d.Texture2D)wrapped).getDetailImage().getUserData();
    }
    ...
    public void setDetailTextureMode(int mode) {
        ((javax.media.j3d.Texture2D)wrapped).setDetailTextureMode( mode );
    }
    ...
    public int getDetailTextureMode() {
       return ((javax.media.j3d.Texture2D)wrapped).getDetailTextureMode();
    }
    ...
    public void setDetailTextureLevel(int level) {
        ((javax.media.j3d.Texture2D)wrapped).setDetailTextureLevel( level );
    }
    ...
    public int getDetailTextureLevel() {
       return ((javax.media.j3d.Texture2D)wrapped).getDetailTextureLevel();
    }
    ...
    public void setDetailTextureFunc(float[] lod, float[] pts) {
        ((javax.media.j3d.Texture2D)wrapped).setDetailTextureFunc( lod, pts );
    }
    ...
    public void setDetailTextureFunc(Point2f[] pts) {
        ((javax.media.j3d.Texture2D)wrapped).setDetailTextureFunc( pts );
    }
    ...
    public int getDetailTextureFuncPointsCount() {
        return ((javax.media.j3d.Texture2D)wrapped).getDetailTextureFuncPointsCount();
    }
    ...
    public void getDetailTextureFunc(float[] lod, float[] pts) {
        ((javax.media.j3d.Texture2D)wrapped).getDetailTextureFunc( lod, pts );
    }
