...
import org.jdesktop.lg3d.sg.internal.wrapper.PickSegmentWrapper;
...
public final class PickSegment extends PickShape {
    ...
    public PickSegment(Point3f start, Point3f end) {        
        wrapped = new javax.media.j3d.PickSegment( new Point3d(start), new Point3d(end));        
    }
    ...
    public void set(Point3f start, Point3f end) {        
        ((javax.media.j3d.PickSegment)wrapped).set( new Point3d(start), new Point3d(end));        
    }
