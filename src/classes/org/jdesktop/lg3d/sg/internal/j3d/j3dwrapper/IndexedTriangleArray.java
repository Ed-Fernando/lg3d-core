...
import org.jdesktop.lg3d.sg.internal.wrapper.IndexedTriangleArrayWrapper;
...
public class IndexedTriangleArray extends IndexedGeometryArray implements IndexedTriangleArrayWrapper {
    ...
    public IndexedTriangleArray(int vertexCount,
				...
				int[] texCoordSetMap,
				int indexCount) {
        assert(this.getClass()==IndexedTriangleArray.class);
	wrapped = new javax.media.j3d.IndexedTriangleArray(vertexCount,
				 vertexFormat,
				 texCoordSetCount,
				 texCoordSetMap,
				 indexCount);
