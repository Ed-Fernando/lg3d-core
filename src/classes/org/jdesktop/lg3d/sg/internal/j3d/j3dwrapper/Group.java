...
public class Group extends Node implements GroupWrapper {
    ...
    public void setChild(NodeWrapper child, int index) {
        assert( child!=null );
	((javax.media.j3d.Group)wrapped).setChild( (javax.media.j3d.Node)((Node)child).wrapped, index );
    }
    ...
    public void insertChild(NodeWrapper child, int index) {
        assert( child!=null );
	((javax.media.j3d.Group)wrapped).insertChild( (javax.media.j3d.Node)((Node)child).wrapped, index );
    }
	...
	((javax.media.j3d.Group)wrapped).removeChild( index );
    }
	...
	return (NodeWrapper)((javax.media.j3d.Group)wrapped).getChild( index ).getUserData();
    }
	...
	Enumeration e = ((javax.media.j3d.Group)wrapped).getAllChildren();
        Vector list = new Vector( ((javax.media.j3d.Group)wrapped).numChildren() );
        
        while(e.hasMoreElements()) {
            list.add( ((javax.media.j3d.Node)e.nextElement()).getUserData() );
        }
    ...
    public void addChild(NodeWrapper child) {
        assert( child!=null );
	((javax.media.j3d.Group)wrapped).addChild( (javax.media.j3d.Node)((Node)child).wrapped );
    }
	...
	((javax.media.j3d.Group)wrapped).moveTo( (javax.media.j3d.BranchGroup)((BranchGroup)branchGroup).wrapped );
    }
	...
	return ((javax.media.j3d.Group)wrapped).numChildren();
    }
    ...
    public int indexOfChild(NodeWrapper child) {
        return ((javax.media.j3d.Group)wrapped).indexOfChild( (javax.media.j3d.Node)((Node)child).wrapped );
    }
    ...
    public void removeChild(NodeWrapper child) {
        assert( child!=null );
        ((javax.media.j3d.Group)wrapped).removeChild( (javax.media.j3d.Node)((Node)child).wrapped );
    }
    ...
    public void removeAllChildren() {
        ((javax.media.j3d.Group)wrapped).removeAllChildren();
    }
    ...
    protected void createWrapped() {
        wrapped = new javax.media.j3d.Group();
        wrapped.setUserData( this );
    }
    
    public GroupWrapper newGroup() {
        return new Group();
    }
}
