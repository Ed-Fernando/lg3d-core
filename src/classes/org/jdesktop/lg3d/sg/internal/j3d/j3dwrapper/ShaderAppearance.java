 ...
 *
 */
public class ShaderAppearance extends Appearance implements ShaderAppearanceWrapper {
    ...
    protected void createWrapped() {
        wrapped = new javax.media.j3d.ShaderAppearance();
    ...
    public void setShaderProgram(ShaderProgramWrapper shaderProgram) {
        if (shaderProgram==null)
            ((javax.media.j3d.ShaderAppearance)wrapped).setShaderProgram(null);
        else
            ((javax.media.j3d.ShaderAppearance)wrapped).setShaderProgram((javax.media.j3d.ShaderProgram)((ShaderProgramWrapper)shaderProgram).getWrapped());
    }
    ...
    public ShaderProgramWrapper getShaderProgram() {
        ...
        return (ShaderProgramWrapper)w.getUserData();
    }
    ...
    public void setShaderAttributeSet(ShaderAttributeSetWrapper shaderAttributeSet) {
        if (shaderAttributeSet==null)
            ((javax.media.j3d.ShaderAppearance)wrapped).setShaderAttributeSet(null);
        else
            ((javax.media.j3d.ShaderAppearance)wrapped).setShaderAttributeSet((javax.media.j3d.ShaderAttributeSet)shaderAttributeSet.getWrapped());
    }
    ...
    public ShaderAttributeSetWrapper getShaderAttributeSet() {
        ...
        return (ShaderAttributeSetWrapper)w.getUserData();
   }
