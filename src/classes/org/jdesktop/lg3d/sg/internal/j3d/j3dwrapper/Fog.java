...
public abstract class Fog extends Leaf implements FogWrapper {
	...
	((javax.media.j3d.Fog)wrapped).setColor( color );
    }
	...
	((javax.media.j3d.Fog)wrapped).setColor( r,g,b );
    }
	...
	((javax.media.j3d.Fog)wrapped).getColor( color );
    }
    ...
    public void setInfluencingBounds(BoundsWrapper region) {
    	((javax.media.j3d.Fog)wrapped).setInfluencingBounds( ((Bounds)region).wrapped );
    }
    ...
    public BoundsWrapper getInfluencingBounds() {
    	javax.media.j3d.Bounds j3dBounds = ((javax.media.j3d.Fog)wrapped).getInfluencingBounds();
...
//    }
	...
	((javax.media.j3d.Fog)wrapped).setScope( (javax.media.j3d.Group)((Group)scope).wrapped, index );
    }
	...
	return (Group)((javax.media.j3d.Fog)wrapped).getScope(index).getUserData();
    }
	...
	((javax.media.j3d.Fog)wrapped).insertScope( (javax.media.j3d.Group)((Group)scope).wrapped, index );
    }
	...
	((javax.media.j3d.Fog)wrapped).removeScope( index );
    }
	...
	Enumeration e = ((javax.media.j3d.Fog)wrapped).getAllScopes();
	...
	((javax.media.j3d.Fog)wrapped).addScope( (javax.media.j3d.Group)((Group)scope).wrapped );
    }
	...
	return ((javax.media.j3d.Fog)wrapped).numScopes();
     }
	...
	return ((javax.media.j3d.Fog)wrapped).indexOfScope( (javax.media.j3d.Group)((Group)scope).wrapped );
     }
	...
	((javax.media.j3d.Fog)wrapped).removeScope( (javax.media.j3d.Group)((Group)scope).wrapped );
    }
	...
	((javax.media.j3d.Fog)wrapped).removeAllScopes();
    }
