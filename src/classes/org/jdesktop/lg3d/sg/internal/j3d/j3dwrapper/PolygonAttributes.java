...
public class PolygonAttributes extends NodeComponent implements PolygonAttributesWrapper {
	...
	wrapped = new javax.media.j3d.PolygonAttributes();
    ...
    public void setCullFace(int cullFace) {
        ((javax.media.j3d.PolygonAttributes)wrapped).setCullFace(cullFace);
    }
    ...
    public int getCullFace() {
        return ((javax.media.j3d.PolygonAttributes)wrapped).getCullFace();
    }
    ...
    public void setBackFaceNormalFlip(boolean backFaceNormalFlip) {
        ((javax.media.j3d.PolygonAttributes)wrapped).setBackFaceNormalFlip(backFaceNormalFlip);
    }
    ...
    public boolean getBackFaceNormalFlip() {
        return ((javax.media.j3d.PolygonAttributes)wrapped).getBackFaceNormalFlip();
    }
    ...
    public void setPolygonMode(int polygonMode) {
        ((javax.media.j3d.PolygonAttributes)wrapped).setPolygonMode(polygonMode);
    }
    ...
    public int getPolygonMode() {
        return ((javax.media.j3d.PolygonAttributes)wrapped).getPolygonMode();
    }
    ...
    public void setPolygonOffset(float polygonOffset) {
        ((javax.media.j3d.PolygonAttributes)wrapped).setPolygonOffset(polygonOffset);
    }
    ...
    public float getPolygonOffset() {
        return ((javax.media.j3d.PolygonAttributes)wrapped).getPolygonOffset();
    }
    ...
    public void setPolygonOffsetFactor(float polygonOffsetFactor) {
        ((javax.media.j3d.PolygonAttributes)wrapped).setPolygonOffsetFactor(polygonOffsetFactor);
    }
    ...
    public float getPolygonOffsetFactor() {
        return ((javax.media.j3d.PolygonAttributes)wrapped).getPolygonOffsetFactor();
    }
