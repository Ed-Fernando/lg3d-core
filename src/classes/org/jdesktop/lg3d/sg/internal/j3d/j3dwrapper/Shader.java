...
public abstract class Shader extends NodeComponent implements ShaderWrapper {
	...
	return ((javax.media.j3d.Shader)wrapped).getShadingLanguage();
    }
	...
	return ((javax.media.j3d.Shader)wrapped).getShaderType();
    }
}
