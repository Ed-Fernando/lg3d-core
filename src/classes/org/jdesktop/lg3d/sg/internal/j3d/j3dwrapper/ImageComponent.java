...
public abstract class ImageComponent extends NodeComponent implements ImageComponentWrapper {
  ...
  // Change this if any more formats are added or removed
     ...
     */  
    public int getWidth() {
        return ((javax.media.j3d.ImageComponent)wrapped).getWidth();
    }
    ...
    public int getHeight() {
        return ((javax.media.j3d.ImageComponent)wrapped).getHeight();
    }
    ...
    public int getFormat() {
        return ((javax.media.j3d.ImageComponent)wrapped).getFormat();
    }
    ...
    public boolean isByReference() {
        return ((javax.media.j3d.ImageComponent)wrapped).isByReference();
    }
    ...
    public void setYUp(boolean yUp) {
        ((javax.media.j3d.ImageComponent)wrapped).setYUp( yUp );
    }
    ...
    public boolean isYUp() {
        return ((javax.media.j3d.ImageComponent)wrapped).isYUp();
    }
