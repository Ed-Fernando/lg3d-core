...
public class Transform3D implements Transform3DWrapper {
    ...
    javax.media.j3d.Transform3D wrapped;
...
//    }
     ...
     */
    public Transform3D(Transform3DWrapper t1) {
	wrapped = new javax.media.j3d.Transform3D(((Transform3D)t1).wrapped);
    }
   ...
   /**
	...
	wrapped.add( ((Transform3D)t1).wrapped );
    }
	...
	wrapped.add( ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    }
    ...
    public final void sub(Transform3DWrapper t1) {
        wrapped.sub( ((Transform3D)t1).wrapped );
    }
	...
	wrapped.sub( ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    } 
   ...
   /**
    ...
    public final void transpose(Transform3DWrapper t1) {
        wrapped.transpose( ((Transform3D)t1).wrapped );
    }
   ...
   /**
     ...
     */
     public final void setScale(Vector3f scale) {
       wrapped.setScale( new Vector3d(scale));
     }
    ...
    public final void setNonUniformScale(double xScale,
					 double yScale,
					 double zScale) {
        wrapped.setNonUniformScale( xScale, yScale, zScale );                                        
    }
    ...
    public final void set(Transform3DWrapper t1){
        wrapped.set( ((Transform3D)t1).wrapped );
    }
   ...
   /**   
	...
	wrapped.invert( ((Transform3D)t1).wrapped );
    }
   ...
   /**
	...
	wrapped.mul( scalar, ((Transform3D)t1).wrapped );
    }
	...
	wrapped.mul( ((Transform3D)t1).wrapped );
    } 
    ...
    {
	wrapped.mul( ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    } 
	...
	wrapped.mulInverse( ((Transform3D)t1).wrapped );
    } 
    ...
    public final void mulInverse(Transform3DWrapper t1, Transform3DWrapper t2) {
        wrapped.mulInverse( ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    } 
	...
	wrapped.mulTransposeRight( ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    }
    ...
    public final void mulTransposeLeft(Transform3DWrapper t1, Transform3DWrapper t2){
        wrapped.mulTransposeLeft( ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    }
	...
	wrapped.mulTransposeBoth( ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    }
	...
	wrapped.normalize( ((Transform3D)t1).wrapped );
    }
	...
	wrapped.normalizeCP( ((Transform3D)t1).wrapped );
    }
    ...
    public boolean equals(Transform3DWrapper t1) {
        System.out.println("J3dwrapper t3d "+(((Transform3D)t1).wrapped.toString()));
        System.out.println("J3dwrapper t3d "+wrapped.toString());
	return wrapped.equals( ((Transform3D)t1).wrapped );
    } 
   ...
   /**
    ...
    public boolean equals(Object o1) {
        if (o1 instanceof Transform3DWrapper)
            return wrapped.equals( ((Transform3D)o1).wrapped );
        System.out.println("J3dwrapper t3d wrong equals "+o1.getClass().getName());
    ...
    public boolean epsilonEquals(Transform3DWrapper t1, double epsilon) {
        return wrapped.epsilonEquals( ((Transform3D)t1).wrapped, epsilon );
    }
	...
	wrapped.scaleAdd( s, ((Transform3D)t1).wrapped, ((Transform3D)t2).wrapped );
    }
	...
	wrapped.scaleAdd( s, ((Transform3D)t1).wrapped );
   }
    ...
    public javax.media.j3d.Transform3D getWrapped() {
        return wrapped;
    }
