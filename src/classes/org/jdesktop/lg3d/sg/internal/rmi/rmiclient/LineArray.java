...
import org.jdesktop.lg3d.sg.internal.wrapper.LineArrayWrapper;

/**
 */

public class LineArray extends GeometryArray implements LineArrayWrapper {
    ...
    protected void createRemote() {
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newInstance(org.jdesktop.lg3d.sg.internal.rmi.rmiserver.LineArray.class);
            setRemote( remote );
    ...
    public LineArray(int vertexCount,
			 ...
			 int[] texCoordSetMap) {
        assert(this.getClass()==LineArray.class);
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newInstance(
                org.jdesktop.lg3d.sg.internal.rmi.rmiserver.LineArray.class,
