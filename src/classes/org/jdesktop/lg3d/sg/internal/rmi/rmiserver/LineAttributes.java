 ...
 * @see View
 */
public class LineAttributes extends NodeComponent implements LineAttributesRemote {
     ...
     * </ul>
     */
     public LineAttributes()  throws java.rmi.RemoteException {
      }
     ...
     */
     public LineAttributes(float lineWidth, int linePattern,
			   boolean lineAntialiasing) throws java.rmi.RemoteException {
     ...
     */
    public void setLineWidth(float lineWidth)  throws java.rmi.RemoteException {
        ((LineAttributesWrapper)wrapped).setLineWidth(lineWidth);
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public float getLineWidth()  throws java.rmi.RemoteException {
        return ((LineAttributesWrapper)wrapped).getLineWidth();
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void setLinePattern(int linePattern)  throws java.rmi.RemoteException {
        ((LineAttributesWrapper)wrapped).setLinePattern(linePattern);
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public int getLinePattern()  throws java.rmi.RemoteException {
        return ((LineAttributesWrapper)wrapped).getLinePattern();
    }
     ...
     * @since Java 3D 1.2
     */
    public void setPatternMask(int mask)  throws java.rmi.RemoteException {
        ((LineAttributesWrapper)wrapped).setPatternMask(mask);
    }
     ...
     * @since Java 3D 1.2
     */
    public int getPatternMask()  throws java.rmi.RemoteException {
        return ((LineAttributesWrapper)wrapped).getPatternMask();
    }
     ...
     * @since Java 3D 1.2
     */
    public void setPatternScaleFactor(int scaleFactor)  throws java.rmi.RemoteException {
        ((LineAttributesWrapper)wrapped).setPatternScaleFactor(scaleFactor);
    }
     ...
     * @since Java 3D 1.2
     */
    public int getPatternScaleFactor() throws java.rmi.RemoteException {
        return ((LineAttributesWrapper)wrapped).getPatternScaleFactor();
    }
     ...
     * @see View
     */
    public void setLineAntialiasingEnable(boolean state) throws java.rmi.RemoteException {
        ((LineAttributesWrapper)wrapped).setLineAntialiasingEnable(state);
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public boolean getLineAntialiasingEnable() throws java.rmi.RemoteException {
        return ((LineAttributesWrapper)wrapped).getLineAntialiasingEnable();
    }
