...
public abstract class ImageComponent extends NodeComponent implements ImageComponentRemote {
    //
    // Pixel format values
    //
  ...
  // Change this if any more formats are added or removed
     ...
     */
    ImageComponent() throws java.rmi.RemoteException {
    }
     ...
     */  
    public ImageComponent(int format, int width, int height) throws java.rmi.RemoteException {
    }
    ...
    public int getWidth() throws java.rmi.RemoteException {
        return ((org.jdesktop.lg3d.sg.ImageComponent)wrapped).getWidth();
    }
    ...
    public int getHeight() throws java.rmi.RemoteException {
        return ((org.jdesktop.lg3d.sg.ImageComponent)wrapped).getHeight();
    }
    ...
    public int getFormat() throws java.rmi.RemoteException {
        return ((org.jdesktop.lg3d.sg.ImageComponent)wrapped).getFormat();
    }
    ...
    public boolean isByReference() throws java.rmi.RemoteException {
        return ((org.jdesktop.lg3d.sg.ImageComponent)wrapped).isByReference();
    }
    ...
    public void setYUp(boolean yUp) throws java.rmi.RemoteException {
        ((org.jdesktop.lg3d.sg.ImageComponent)wrapped).setYUp( yUp );
    }
    ...
    public boolean isYUp() throws java.rmi.RemoteException {
        return ((org.jdesktop.lg3d.sg.ImageComponent)wrapped).isYUp();
    }
