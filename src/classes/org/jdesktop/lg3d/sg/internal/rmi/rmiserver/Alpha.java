...
public class Alpha extends NodeComponent implements AlphaRemote {
     ...
     * </ul>
     */
    public Alpha()  throws java.rmi.RemoteException {
    }
    
    protected void createWrapped() {
        wrapped = new org.jdesktop.lg3d.sg.Alpha();
    }
    ...
    public Alpha(int loopCount, int mode,
		 ...
		 long alphaAtZeroDuration)  throws java.rmi.RemoteException {
    ...
    public Alpha(int loopCount,
		 ...
		 long increasingAlphaDuration,
		 long increasingAlphaRampDuration,
		 long alphaAtOneDuration)  throws java.rmi.RemoteException {
    ...
    /**
      ...
      * from zero to one
      */ 
    public Alpha(int loopCount, long increasingAlphaDuration)  throws java.rmi.RemoteException {
        setLoopCount(loopCount);
        setIncreasingAlphaDuration(increasingAlphaDuration);
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).pause( time );
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).resume();
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).isPaused();
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getPauseTime();
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).value();
    }
    ...
    public float value(long atTime)  throws java.rmi.RemoteException {
        return ((org.jdesktop.lg3d.sg.Alpha)wrapped).value(atTime);
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getStartTime();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setStartTime( startTime );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getLoopCount();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setLoopCount( loopCount );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getMode();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setMode(mode);
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getTriggerTime();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setTriggerTime( triggerTime );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getPhaseDelayDuration();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setPhaseDelayDuration( phaseDelayDuration );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getIncreasingAlphaDuration();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setIncreasingAlphaDuration( increasingAlphaDuration );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getIncreasingAlphaRampDuration();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setIncreasingAlphaRampDuration( increasingAlphaRampDuration );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getAlphaAtOneDuration();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setAlphaAtOneDuration( alphaAtOneDuration );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getDecreasingAlphaDuration();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setDecreasingAlphaDuration( decreasingAlphaDuration );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getDecreasingAlphaRampDuration();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setDecreasingAlphaRampDuration( decreasingAlphaRampDuration );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).getAlphaAtZeroDuration();
    }
	...
	((org.jdesktop.lg3d.sg.Alpha)wrapped).setAlphaAtZeroDuration( alphaAtZeroDuration );
    }
	...
	return ((org.jdesktop.lg3d.sg.Alpha)wrapped).finished();
    }
}
