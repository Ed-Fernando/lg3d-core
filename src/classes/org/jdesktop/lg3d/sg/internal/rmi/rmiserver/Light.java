...
public abstract class Light extends Leaf implements LightRemote {

    public Light() throws java.rmi.RemoteException {
    }
     ...
     */
    public Light(Color3f color) throws java.rmi.RemoteException {
    }
     ...
     * @param color the color of the light source
     */
    public Light(boolean lightOn, Color3f color) throws java.rmi.RemoteException {
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).setEnable( state );
    }
	...
	return ((org.jdesktop.lg3d.sg.Light)wrapped).getEnable();
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).setColor( color );
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).getColor( color );
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).setScope( (org.jdesktop.lg3d.sg.Group)((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.Group)scope).wrapped, index );
    }
	...
	return (Group)((org.jdesktop.lg3d.sg.Light)wrapped).getScope(index).getUserData();
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).insertScope( (org.jdesktop.lg3d.sg.Group)((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.Group)scope).wrapped, index );
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).removeScope( index );
    }
	...
	Enumeration e = ((org.jdesktop.lg3d.sg.Light)wrapped).getAllScopes();
        java.util.Vector v = new java.util.Vector();
        while(e.hasMoreElements())
            v.add( ((org.jdesktop.lg3d.sg.Group)e.nextElement()).getUserData() );
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).addScope( (org.jdesktop.lg3d.sg.Group)((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.Group)scope).wrapped );
    }
	...
	return ((org.jdesktop.lg3d.sg.Light)wrapped).numScopes();
    }
	...
	return ((org.jdesktop.lg3d.sg.Light)wrapped).indexOfScope( (org.jdesktop.lg3d.sg.Group)((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.Group)scope).wrapped );
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).removeScope( (org.jdesktop.lg3d.sg.Group)((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.Group)scope).wrapped );
    }
	...
	((org.jdesktop.lg3d.sg.Light)wrapped).removeAllScopes();
    }
    ...
    public void setInfluencingBounds(BoundsRemote region) throws java.rmi.RemoteException {
    	//((org.jdesktop.lg3d.sg.Light)wrapped).setInfluencingBounds( region.wrapped );
    ...
    public BoundsRemote getInfluencingBounds() throws java.rmi.RemoteException {
    	org.jdesktop.lg3d.sg.Bounds j3dBounds = ((org.jdesktop.lg3d.sg.Light)wrapped).getInfluencingBounds();
     ...
     * not set and this object is part of live or compiled scene graph
     */
//    public void setInfluencingBoundingLeaf(BoundingLeaf region) throws java.rmi.RemoteException {
//    	if (isLiveOrCompiled())
...
//    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
//    public BoundingLeaf getInfluencingBoundingLeaf() throws java.rmi.RemoteException {
//    	if (isLiveOrCompiled())
