...
public class DirectionalLight extends Light implements DirectionalLightRemote {
 /**
  ...
  */
  ...
  public static final int
     ...
     * </ul>
     */
    public DirectionalLight() throws java.rmi.RemoteException {
    }
    
    protected void createWrapped() {
        wrapped = new org.jdesktop.lg3d.sg.DirectionalLight();
     ...
     * to the object
     */
    public DirectionalLight(Color3f color, Vector3f direction) throws java.rmi.RemoteException {
        setColor(color);
     ...
     * to the object
     */
    public DirectionalLight(boolean lightOn, Color3f color, Vector3f direction) throws java.rmi.RemoteException {
        setColor(color);
        setDirection(direction);
        setEnable(lightOn);
    }
   ...
   */
    public void setDirection(Vector3f direction) throws java.rmi.RemoteException {
        ((org.jdesktop.lg3d.sg.DirectionalLight)wrapped).setDirection( direction );
    }
   ...
   */
    public void setDirection(float x, float y, float z) throws java.rmi.RemoteException {
        ((org.jdesktop.lg3d.sg.DirectionalLight)wrapped).setDirection( x,y,z );
  }
   ...
   */
    public void getDirection(Vector3f direction) throws java.rmi.RemoteException {
        ((org.jdesktop.lg3d.sg.DirectionalLight)wrapped).getDirection( direction );
    }
