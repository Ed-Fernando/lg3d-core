 ...
 */
public class Material extends NodeComponent implements MaterialRemote {
     ...
     * </ul>
     */
    public Material() throws java.rmi.RemoteException {
    }
    
    protected void createWrapped() {
	wrapped = new org.jdesktop.lg3d.sg.Material();
    ...
    public Material(Color3f ambientColor,
		    ...
		    float shininess) throws java.rmi.RemoteException 
    {
     ...
     * @see #setColorTarget
     */
    public void setAmbientColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setAmbientColor( color );
    }
     ...
     * @see #setColorTarget
     */
    public void setAmbientColor(float r, float g, float b) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setAmbientColor( r,g,b );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void getAmbientColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).getAmbientColor( color );
    }
     ...
     * @see #setColorTarget
     */
    public void setEmissiveColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setEmissiveColor( color );
    }
     ...
     * @see #setColorTarget
     */
    public void setEmissiveColor(float r, float g, float b) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setEmissiveColor( r,g,b );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void getEmissiveColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).getEmissiveColor( color );
    }
     ...
     * @see #setColorTarget
     */
    public void setDiffuseColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setDiffuseColor( color );
    }
     ...
     * @see #setColorTarget
     */
    public void setDiffuseColor(float r, float g, float b) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setDiffuseColor( r,g,b );
    }
     ...
     * @see #setColorTarget
     */
    public void setDiffuseColor(float r, float g, float b, float a) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setDiffuseColor( r,g,b,a );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void getDiffuseColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).getDiffuseColor( color );
    }
     ...
     * @see #setColorTarget
     */
    public void setSpecularColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setSpecularColor( color );
    }
     ...
     * @see #setColorTarget
     */
    public void setSpecularColor(float r, float g, float b) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setSpecularColor( r,g,b );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void getSpecularColor(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).getSpecularColor( color );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void setShininess(float shininess) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setShininess( shininess );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public float getShininess() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.Material)wrapped).getShininess();
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void setLightingEnable(boolean state) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setLightingEnable( state );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public boolean getLightingEnable() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.Material)wrapped).getLightingEnable();
    }
     ...
     * @since Java 3D 1.3
     */
    public void setColorTarget(int colorTarget) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Material)wrapped).setColorTarget( colorTarget );
    }
     ...
     * @since Java 3D 1.3
     */
    public int getColorTarget() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.Material)wrapped).getColorTarget();
    }
	...
	return ((org.jdesktop.lg3d.sg.Material)wrapped).toString();
    }
