...
import org.jdesktop.lg3d.sg.internal.wrapper.RotationInterpolatorWrapper;
...
import org.jdesktop.lg3d.sg.internal.rmi.rmiserver.RotationInterpolatorRemote;
...
public class RotationInterpolator extends Node implements RotationInterpolatorWrapper {
    ...
    public RotationInterpolator(AlphaWrapper alpha, TransformGroupWrapper target) {
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newRotationInterpolator( 
                            (AlphaRemote)((Alpha)alpha).remote, 
                            (TransformGroupRemote)((TransformGroup)target).remote );
            setRemote( remote );
    ...
    public RotationInterpolator(AlphaWrapper alpha,
        ...
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newRotationInterpolator(  
                            (AlphaRemote)((Alpha)alpha).remote, 
                            (TransformGroupRemote)((TransformGroup)target).remote );
//            setTransformAxis( axisOfTransform );
...
//            setMaximumAngle( maximumAngle );
    ...
    public void setMinimumAngle(float angle) {
        try {
            ((RotationInterpolatorRemote)remote).setMinimumAngle( angle );
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException( rex );
        }
    }
    ...
    public float getMinimumAngle() {
        try {
            return ((RotationInterpolatorRemote)remote).getMinimumAngle();
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException( rex );
        }
    }
    ...
    public void setMaximumAngle(float angle) {
        try {
            ((RotationInterpolatorRemote)remote).setMaximumAngle( angle );
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException( rex );
        }
    }
    ...
    public float getMaximumAngle() {
        try {
            return ((RotationInterpolatorRemote)remote).getMaximumAngle();
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException( rex );
        }
    }
