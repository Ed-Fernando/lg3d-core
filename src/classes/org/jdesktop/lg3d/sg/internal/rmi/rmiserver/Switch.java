...
public class Switch extends Group implements SwitchRemote {
     ...
     * </ul>
     */
    public Switch() throws java.rmi.RemoteException {
        if (this.getClass()==Switch.class) {
            wrapped = new org.jdesktop.lg3d.sg.Switch();
     ...
     */
    public Switch(int whichChild) throws java.rmi.RemoteException {
        wrapped = new org.jdesktop.lg3d.sg.Switch(whichChild);
        wrapped.setUserData( this );
    }
     ...
     */
    public Switch(int whichChild, BitSet childMask) throws java.rmi.RemoteException {
        wrapped = new org.jdesktop.lg3d.sg.Switch(whichChild, childMask);
        wrapped.setUserData( this );
    }
     ...
     * @see #CHILD_MASK
     */
    public void setWhichChild(int child) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Switch)wrapped).setWhichChild(child);
    }
     ...
     * @see #CHILD_MASK
     */
    public int getWhichChild() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.Switch)wrapped).getWhichChild();
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void setChildMask(BitSet childMask) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.Switch)wrapped).setChildMask(childMask);
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public BitSet getChildMask() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.Switch)wrapped).getChildMask();
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public NodeRemote currentChild() throws java.rmi.RemoteException {
	org.jdesktop.lg3d.sg.Node j3dNode = ((org.jdesktop.lg3d.sg.Switch)wrapped).currentChild();
        if (j3dNode==null)
            return null;
        else
