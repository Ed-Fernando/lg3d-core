...
public abstract class ImageComponent extends NodeComponent implements ImageComponentWrapper {
    //
    // Pixel format values
    //
  ...
  // Change this if any more formats are added or removed
    ...
    public int getWidth() {
        try {
            return ((ImageComponentRemote)remote).getWidth();
    ...
    public int getHeight() {
        try {
            return ((ImageComponentRemote)remote).getHeight();
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public int getFormat() {
        try {
            return ((ImageComponentRemote)remote).getFormat();
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public boolean isByReference() {
        try {
            return ((ImageComponentRemote)remote).isByReference();
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public void setYUp(boolean yUp) {
        try {
            ((ImageComponentRemote)remote).setYUp( yUp );
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public boolean isYUp() {
        try {
            return ((ImageComponentRemote)remote).isYUp();
        } catch( java.rmi.RemoteException rex ) {
            throw new RuntimeException(rex);
        }
    }
