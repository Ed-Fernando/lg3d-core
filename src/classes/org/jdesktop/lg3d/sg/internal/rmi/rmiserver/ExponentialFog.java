 ...
 */
public class ExponentialFog extends Fog implements ExponentialFogRemote {
    /**
     ...
     * </ul>
     */
    public ExponentialFog() throws java.rmi.RemoteException {
	// Just use the defaults
    }

    protected void createWrapped() {
        wrapped = new org.jdesktop.lg3d.sg.ExponentialFog();
     ...
     */
    public ExponentialFog(Color3f color) throws java.rmi.RemoteException {
	setColor(color);
    }
     ...
     */
    public ExponentialFog(Color3f color, float density) throws java.rmi.RemoteException {
	setColor(color);
        setDensity(density);
    }
     ...
     */
    public ExponentialFog(float r, float g, float b) throws java.rmi.RemoteException {
	setColor(r,g,b);
    }
     ...
     * @param density the density of the fog
     */
    public ExponentialFog(float r, float g, float b, float density) throws java.rmi.RemoteException {
	setColor(r,g,b);
        setDensity(density);
    }
     ...
     */
    public void setDensity(float density) throws java.rmi.RemoteException {
        ((org.jdesktop.lg3d.sg.ExponentialFog)wrapped).setDensity(density);
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public float getDensity() throws java.rmi.RemoteException {
        return ((org.jdesktop.lg3d.sg.ExponentialFog)wrapped).getDensity();
    }
