...
public class TransformGroup extends Group implements TransformGroupRemote{
  /**
  ...
  public static final int
     ...
     * identity transform.
     */
    public TransformGroup() throws java.rmi.RemoteException {
        wrapped = new org.jdesktop.lg3d.sg.TransformGroup();
     ...
     */
    public TransformGroup(Transform3D t1) throws java.rmi.RemoteException {
	wrapped = new org.jdesktop.lg3d.sg.TransformGroup( t1.wrapped );
        wrapped.setUserData( this );
    }
	...
	((org.jdesktop.lg3d.sg.TransformGroup)wrapped).setTransform( (org.jdesktop.lg3d.sg.Transform3D)SGObjectFactoryImpl.getFactoryImpl().getLocal(t1).wrapped );
    }
   ...
   */
    public void getTransform(Transform3DRemote t1) throws java.rmi.RemoteException {
        //((org.jdesktop.lg3d.sg.TransformGroup)wrapped).getTransform( t1.getWrapped() );
    }
