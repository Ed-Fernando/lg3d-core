...
public class TriangleStripArray extends GeometryStripArray implements TriangleStripArrayRemote {

    // non-public, no parameter constructor
    TriangleStripArray() throws java.rmi.RemoteException {}
    ...
    public TriangleStripArray(int vertexCount,
        ...
        wrapped = new org.jdesktop.lg3d.sg.TriangleStripArray(  vertexCount,
                                                           vertexFormat,
                                                           stripVertexCounts );
