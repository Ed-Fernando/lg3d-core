...
public class IndexedTriangleFanArray extends IndexedGeometryStripArray implements IndexedTriangleFanArrayRemote {

    // non-public, no parameter constructor
    IndexedTriangleFanArray() throws java.rmi.RemoteException {}
	...
	wrapped = new org.jdesktop.lg3d.sg.IndexedTriangleFanArray(vertexCount,
				    vertexFormat,
				    texCoordSetCount,
				    texCoordSetMap,
				    indexCount,
