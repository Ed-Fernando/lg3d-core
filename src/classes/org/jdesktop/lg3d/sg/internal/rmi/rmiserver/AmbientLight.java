...
public class AmbientLight extends Light implements AmbientLightRemote {
    /**
     * Constructs and initializes an ambient light using default parameters.
     */
    public AmbientLight() throws java.rmi.RemoteException {
    }
    
    protected void createWrapped() {
        wrapped = new org.jdesktop.lg3d.sg.AmbientLight();
     ...
     */
    public AmbientLight(Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.AmbientLight)wrapped).setColor(color);
    }
     ...
     * @param color the color of the light source.
     */
    public AmbientLight(boolean lightOn, Color3f color) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.AmbientLight)wrapped).setColor(color);
	((org.jdesktop.lg3d.sg.AmbientLight)wrapped).setEnable(lightOn);
    }
