...
public final class PickBounds extends PickShape {
    ...
    public PickBounds() {
	bounds = null;
	wrapped = new org.jdesktop.lg3d.sg.PickBounds();
    }
	...
	bounds = boundsObject;
	wrapped = new org.jdesktop.lg3d.sg.PickBounds( bounds.wrapped );
    }
	...
	bounds = boundsObject;
        ((org.jdesktop.lg3d.sg.PickBounds)wrapped).set( bounds.wrapped );
    }
