...
public class TriangleArray extends GeometryArray implements TriangleArrayRemote {

    // non-public, no parameter constructor
    TriangleArray() throws java.rmi.RemoteException {}
     ...
     */
    public TriangleArray(int vertexCount, int vertexFormat) throws java.rmi.RemoteException {
	wrapped = new org.jdesktop.lg3d.sg.TriangleArray( vertexCount, vertexFormat );
	...
	wrapped = new org.jdesktop.lg3d.sg.TriangleArray( vertexCount, 
                                                     vertexFormat,
                                                     texCoordSetCount,
                                                     texCoordSetMap );
        wrapped.setUserData( this );
