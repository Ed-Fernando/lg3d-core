 ...
 * 
 */
public class RenderingAttributes extends NodeComponent implements RenderingAttributesRemote {
     ...
     * </ul>
     */
    public RenderingAttributes() throws java.rmi.RemoteException {
    }
    
    protected void createWrapped() {
	wrapped = new org.jdesktop.lg3d.sg.RenderingAttributes();
    ...
    public RenderingAttributes(boolean depthBufferEnable,
			       ...
			       int alphaTestFunction)throws java.rmi.RemoteException {
    ...
    public RenderingAttributes(boolean depthBufferEnable,
			       ...
			       int rasterOp) throws java.rmi.RemoteException {
     ...
     */
    public void setDepthBufferEnable(boolean state)throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setDepthBufferEnable( state );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public boolean getDepthBufferEnable()throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getDepthBufferEnable();
    }
     ...
     */
    public void setDepthBufferWriteEnable(boolean state) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setDepthBufferWriteEnable( state );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public boolean getDepthBufferWriteEnable()throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getDepthBufferWriteEnable();
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void setAlphaTestValue(float value)throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setAlphaTestValue( value );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public float getAlphaTestValue()throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getAlphaTestValue();
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void setAlphaTestFunction(int function)throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setAlphaTestFunction( function );
    }
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public int getAlphaTestFunction()throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getAlphaTestFunction();
    }
	...
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setVisible( visible );
    }
     ...
     * @since Java 3D 1.2
     */
    public boolean getVisible() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getVisible();
    }
     ...
     * @since Java 3D 1.2
     */
    public void setIgnoreVertexColors(boolean ignoreVertexColors) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setIgnoreVertexColors( ignoreVertexColors );
    }
     ...
     * @since Java 3D 1.2
     */
    public boolean getIgnoreVertexColors() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getIgnoreVertexColors();
    }
     ...
     * @since Java 3D 1.2
     */
    public void setRasterOpEnable(boolean rasterOpEnable) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setRasterOpEnable( rasterOpEnable );
    }
     ...
     * @since Java 3D 1.2
     */
    public boolean getRasterOpEnable() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getRasterOpEnable();
    }
     ...
     * @since Java 3D 1.2
     */
    public void setRasterOp(int rasterOp) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).setRasterOp( rasterOp );
    }
     ...
     * @since Java 3D 1.2
     */
    public int getRasterOp() throws java.rmi.RemoteException {
	return ((org.jdesktop.lg3d.sg.RenderingAttributes)wrapped).getRasterOp();
    }
