...
import org.jdesktop.lg3d.sg.internal.rmi.rmiserver.IndexedGeometryStripArrayRemote;
...
public abstract class IndexedGeometryStripArray extends IndexedGeometryArray implements IndexedGeometryStripArrayWrapper {
   ...
   */
    public int getNumStrips(){
        try {
            return ((IndexedGeometryStripArrayRemote)remote).getNumStrips();
    ...
    public void setStripIndexCounts(int[] stripIndexCounts) {
        try {
            ((IndexedGeometryStripArrayRemote)remote).setStripIndexCounts(stripIndexCounts);
        } catch(java.rmi.RemoteException rex) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public void getStripIndexCounts(int[] stripIndexCounts) {
        try {
            ((IndexedGeometryStripArrayRemote)remote).getStripIndexCounts(stripIndexCounts);
        } catch(java.rmi.RemoteException rex) {
            throw new RuntimeException(rex);
        }
    }
