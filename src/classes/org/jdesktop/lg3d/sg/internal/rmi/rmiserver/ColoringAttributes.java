 ...
 * @see Appearance
 */
public class ColoringAttributes extends NodeComponent implements ColoringAttributesRemote {
     ...
     * </ul>
     */
    public ColoringAttributes() throws java.rmi.RemoteException {
    }
    
    protected void createWrapped() {
	wrapped = new org.jdesktop.lg3d.sg.ColoringAttributes();
     ...
     */
    public ColoringAttributes(Color3f color, int shadeModel) throws java.rmi.RemoteException {
	setColor(color);
    ...
    public ColoringAttributes(float red, float green, float blue,
			      int shadeModel) throws java.rmi.RemoteException {
	...
	((org.jdesktop.lg3d.sg.ColoringAttributes)wrapped).setColor( color );
    }
	...
	((org.jdesktop.lg3d.sg.ColoringAttributes)wrapped).setColor( r,g,b );
    }
	...
	((org.jdesktop.lg3d.sg.ColoringAttributes)wrapped).getColor(color);
    }
	...
	((org.jdesktop.lg3d.sg.ColoringAttributes)wrapped).setShadeModel( shadeModel );
    }
	...
	return ((org.jdesktop.lg3d.sg.ColoringAttributes)wrapped).getShadeModel();
    }
