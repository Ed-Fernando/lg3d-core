...
import org.jdesktop.lg3d.sg.internal.wrapper.IndexedTriangleFanArrayWrapper;
...
public class IndexedTriangleFanArray extends IndexedGeometryStripArray implements IndexedTriangleFanArrayWrapper {
    ...
    public IndexedTriangleFanArray(int vertexCount,
        ...
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newInstance(
                    org.jdesktop.lg3d.sg.internal.rmi.rmiserver.IndexedTriangleFanArray.class,
