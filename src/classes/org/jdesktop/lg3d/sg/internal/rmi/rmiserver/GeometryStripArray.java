...
public abstract class GeometryStripArray extends GeometryArray implements GeometryStripArrayRemote {

    // non-public, no parameter constructor
    GeometryStripArray() throws java.rmi.RemoteException {}
    ...
    public GeometryStripArray(int vertexCount,
			      int vertexFormat,
			      int[] stripVertexCounts) throws java.rmi.RemoteException {
    }
	...
	return ((org.jdesktop.lg3d.sg.GeometryStripArray)wrapped).getNumStrips();
    }
     ...
     * @since Java 3D 1.3
     */
    public void setStripVertexCounts(int[] stripVertexCounts) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.GeometryStripArray)wrapped).setStripVertexCounts(stripVertexCounts);
    }
     ...
     */
    public void getStripVertexCounts(int[] stripVertexCounts) throws java.rmi.RemoteException {
	((org.jdesktop.lg3d.sg.GeometryStripArray)wrapped).getStripVertexCounts(stripVertexCounts);
    }
