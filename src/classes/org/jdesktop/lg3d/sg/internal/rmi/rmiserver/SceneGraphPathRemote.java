 ...
 *
 * $RCSfile: SceneGraphPathRemote.java,v $
 *
...
public interface SceneGraphPathRemote extends java.rmi.Remote {

    /**
     * Sets this path's values to that of the specified path.
     * @param newPath the SceneGraphPath to copy
     */
    public void set(SceneGraphPathRemote newPath) throws java.rmi.RemoteException;

    /**
     * Sets this path's Locale to the specified Locale.
     * @param newLocale The new Locale
     */
    //public final void setLocale(Locale newLocale) throws java.rmi.RemoteException;

    /**
     * Sets this path's terminal node to the specified node object.
     * @param object the new terminal node
     */
    public void setObject(NodeRemote  object) throws java.rmi.RemoteException;
     ...
     */
    public void setNodes(NodeRemote nodes[]) throws java.rmi.RemoteException;
     ...
     *
     */
    public void setNode(int index, NodeRemote newNode) throws java.rmi.RemoteException;
     ...
     */
     public void setTransform(Transform3DRemote trans) throws java.rmi.RemoteException;
    ...
    /**
      ...
      */ 
    public Transform3DRemote getTransform() throws java.rmi.RemoteException;

    /**
     * Retrieves the path's Locale
     * @return this path's Locale
     */
    //public final Locale getLocale() throws java.rmi.RemoteException;

    /**
     * Retrieves the path's terminal node object.
     * @return the terminal node
     */
    public NodeRemote getObject() throws java.rmi.RemoteException;
     ...
     */
    public int nodeCount() throws java.rmi.RemoteException;
     ...
     */
    public NodeRemote getNode(int index) throws java.rmi.RemoteException;
   ...
   /**
     ...
     */
    public boolean isSamePath(SceneGraphPath testPath) throws java.rmi.RemoteException;
