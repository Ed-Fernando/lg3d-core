 ...
 *
 * $RCSfile: ImageComponent2DRemote.java,v $
 *
...
public interface ImageComponent2DRemote extends ImageComponentRemote {
     ...
     */
    //public BufferedImage getImage() throws java.rmi.RemoteException;
     ...
     * @since Java 3D 1.3
     */
    public void setSubImage(javax.media.jai.remote.SerializableRenderedImage image, int width, int height,
				int srcX, int srcY, int dstX, int dstY) throws java.rmi.RemoteException;
     ...
     * @since Java 3D 1.3
     */
    public static interface Updater extends org.jdesktop.lg3d.sg.ImageComponent2D.Updater {
	/**
	 * Updates image data that is accessed by reference.
	 ...
	 */
	public void updateData(ImageComponent2DRemote imageComponent,
			       int x, int y,
