...
public abstract class Node extends SceneGraphObject implements NodeRemote {
    ...
    public NodeRemote getParent() throws java.rmi.RemoteException {
        return (NodeRemote)((org.jdesktop.lg3d.sg.Node)wrapped).getParent().getUserData();
    }
	...
	((org.jdesktop.lg3d.sg.Node)wrapped).setBounds( (org.jdesktop.lg3d.sg.Bounds)(SGObjectFactoryImpl.getFactoryImpl().getLocal(bounds).wrapped) );
    }
...
//	return ((NodeRetained)this.retained).getBounds();
	...
	((org.jdesktop.lg3d.sg.Node)wrapped).setBoundsAutoCompute(autoCompute);
    }
	...
	return ((org.jdesktop.lg3d.sg.Node)wrapped).getBoundsAutoCompute();
    }
     ...
     */
    public void getLocalToVworld(Transform3DRemote t) {
	((org.jdesktop.lg3d.sg.Node)wrapped).getLocalToVworld((org.jdesktop.lg3d.sg.Transform3D)(SGObjectFactoryImpl.getFactoryImpl().getLocal(t).wrapped));
    }
     ...
     */
    public void getLocalToVworld(SceneGraphPathRemote path, Transform3DRemote t) {
        throw new RuntimeException("Not implemented");
	//((org.jdesktop.lg3d.sg.Node)wrapped).getLocalToVworld(path.wrapped,t.wrapped);
    }
	...
	((org.jdesktop.lg3d.sg.Node)wrapped).setPickable( pickable );
    }
	...
	return ((org.jdesktop.lg3d.sg.Node)wrapped).getPickable();
    }
