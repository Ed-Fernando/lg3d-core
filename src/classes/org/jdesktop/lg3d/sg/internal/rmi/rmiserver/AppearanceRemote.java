 ...
 *
 * $RCSfile: AppearanceRemote.java,v $
 *
 ...
 */
public interface AppearanceRemote extends NodeComponentRemote {
  ...
  public static final int ALLOW_TEXTURE_UNIT_STATE_WRITE =
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public void setLineAttributes(LineAttributesRemote lineAttributes) throws java.rmi.RemoteException;
     ...
     * not set and this object is part of live or compiled scene graph
     */
    public LineAttributesRemote getLineAttributes() throws java.rmi.RemoteException;
