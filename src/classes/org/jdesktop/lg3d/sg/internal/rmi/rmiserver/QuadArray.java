...
public class QuadArray extends GeometryArray implements QuadArrayRemote {

    QuadArray() throws java.rmi.RemoteException {
    }
     ...
     */
    public QuadArray(int vertexCount, int vertexFormat) throws java.rmi.RemoteException {
	wrapped = new org.jdesktop.lg3d.sg.QuadArray( vertexCount, vertexFormat );
