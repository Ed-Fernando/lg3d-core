 ...
 *
 * $Revision: 1.2 $
 * $Date: 2004-06-23 18:51:00 $
 * $State: Exp $
 */
package org.jdesktop.lg3d.sg.internal.rmi.rmiclient;
import org.jdesktop.lg3d.sg.internal.wrapper.TriangleArrayWrapper;
...
public class TriangleArray extends GeometryArray implements TriangleArrayWrapper {
    ...
    protected void createRemote() {
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newInstance(org.jdesktop.lg3d.sg.internal.rmi.rmiserver.TriangleArray.class);
            setRemote( remote );
    ...
    public TriangleArray(int vertexCount,
        ...
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newInstance(
                org.jdesktop.lg3d.sg.internal.rmi.rmiserver.TriangleArray.class,
