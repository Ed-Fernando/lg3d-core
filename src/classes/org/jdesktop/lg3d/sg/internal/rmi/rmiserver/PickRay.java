...
public final class PickRay extends PickShape {
     ...
     */
    public PickRay() {
	wrapped = new org.jdesktop.lg3d.sg.PickRay();
	...
	wrapped = new org.jdesktop.lg3d.sg.PickRay( origin, 
                                               direction );
    }
	...
	((org.jdesktop.lg3d.sg.PickRay)wrapped).set( origin, 
                                                direction );
    }
	...
	((org.jdesktop.lg3d.sg.PickRay)wrapped).get( origin, direction );
    }
