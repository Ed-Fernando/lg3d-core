...
public abstract class IndexedGeometryStripArray extends IndexedGeometryArray implements IndexedGeometryStripArrayRemote {

    // non-public, no parameter constructor
    IndexedGeometryStripArray() throws java.rmi.RemoteException {}
    ...
    IndexedGeometryStripArray(int vertexCount,
				     int vertexFormat,
				     int indexCount,
				     int[] stripIndexCounts) throws java.rmi.RemoteException {
   ...
   */
	...
	return ((org.jdesktop.lg3d.sg.IndexedGeometryStripArray)wrapped).getNumStrips();
    }
    ...
    public void setStripIndexCounts(int[] stripIndexCounts) throws java.rmi.RemoteException {
        ((org.jdesktop.lg3d.sg.IndexedGeometryStripArray)wrapped).setStripIndexCounts(stripIndexCounts);
    }
    ...
    public void getStripIndexCounts(int[] stripIndexCounts) throws java.rmi.RemoteException {
        ((org.jdesktop.lg3d.sg.IndexedGeometryStripArray)wrapped).getStripIndexCounts(stripIndexCounts);
    }
