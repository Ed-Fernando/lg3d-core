...
public class IndexedTriangleStripArray extends IndexedGeometryStripArray implements IndexedTriangleStripArrayRemote {

    /**
     * Package scoped default constructor
     */
    IndexedTriangleStripArray() throws java.rmi.RemoteException {
    }
	...
	wrapped = new org.jdesktop.lg3d.sg.IndexedTriangleStripArray(vertexCount,
				      vertexFormat,
				      texCoordSetCount,
				      texCoordSetMap,
				      indexCount,
