 ...
 * @see Appearance
 */
public class ColoringAttributes extends NodeComponent implements ColoringAttributesWrapper {
    /**
    ...
    protected void createRemote() {
        try {
            remote = SceneGraphSetup.getSGObjectFactory().newInstance(org.jdesktop.lg3d.sg.internal.rmi.rmiserver.ColoringAttributes.class);
            setRemote( remote );
    ...
    public void setColor(Color3f color) {
        try {
            ((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.ColoringAttributes)remote).setColor(color);
        } catch(java.rmi.RemoteException rex) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public void setColor(float r, float g, float b) {
        try {
            ((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.ColoringAttributes)remote).setColor(r,g,b);
        } catch(java.rmi.RemoteException rex) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public void getColor(Color3f color) {
        try {
            ((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.ColoringAttributes)remote).getColor(color);
        } catch(java.rmi.RemoteException rex) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public void setShadeModel(int shadeModel) {
        try {
            ((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.ColoringAttributes)remote).setShadeModel(shadeModel);
        } catch(java.rmi.RemoteException rex) {
            throw new RuntimeException(rex);
        }
    }
    ...
    public int getShadeModel() {
        try {
            return ((org.jdesktop.lg3d.sg.internal.rmi.rmiserver.ColoringAttributes)remote).getShadeModel();
        } catch(java.rmi.RemoteException rex) {
            throw new RuntimeException(rex);
        }
    }
