...
public class LineArray extends GeometryArray implements LineArrayRemote {

    // non-public, no parameter constructor
    LineArray() throws java.rmi.RemoteException {}
     ...
     */
    public LineArray(int vertexCount, int vertexFormat) throws java.rmi.RemoteException {
	wrapped = new org.jdesktop.lg3d.sg.LineArray( vertexCount, vertexFormat );
	...
	wrapped = new org.jdesktop.lg3d.sg.LineArray( vertexCount, 
                                                     vertexFormat,
                                                     texCoordSetCount,
                                                     texCoordSetMap );
        wrapped.setUserData( this );
