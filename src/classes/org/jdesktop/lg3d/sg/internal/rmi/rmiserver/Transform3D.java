...
public class Transform3D extends java.rmi.server.UnicastRemoteObject implements Transform3DRemote {

    org.jdesktop.lg3d.sg.Transform3D wrapped;
    ...
    */
     ...
     */
    public Transform3D(Matrix4f m1) throws java.rmi.RemoteException {  
        createWrapped();
	wrapped.set(m1);
    }
     ...
     */
    public Transform3D(Transform3D t1) throws java.rmi.RemoteException {
        createWrapped();
	wrapped.set(t1.getWrapped());
    }

    /**
     * Constructs and initializes a transform to the identity matrix.
     */
    public Transform3D() throws java.rmi.RemoteException {
        createWrapped();
    }
   ...
   /**
     ...
     */
    public Transform3D(float[] matrix) throws java.rmi.RemoteException {
        createWrapped();
	wrapped.set(matrix);
    }
   ...
   /**
     ...
     */  
    public Transform3D(Quat4f q1, Vector3f t1, float s) throws java.rmi.RemoteException {
        createWrapped();
	wrapped.set(q1, t1, s);
    }
   ...
   /**    
     ...
     * @param s   the scale value applied to the rotational components   
     */   
    public Transform3D(Matrix3f m1, Vector3f t1, float s) throws java.rmi.RemoteException {    
        createWrapped();
	wrapped.set(m1, t1, s);
    }    
    
    protected void createWrapped() {
        wrapped = new org.jdesktop.lg3d.sg.Transform3D();
    }
   ...
   /**
     ...
     * of this transform
     */
    public final int getType() throws java.rmi.RemoteException {    
   ...
   /**
     ...
     */
    public final int getBestType() throws java.rmi.RemoteException {
	return wrapped.getBestType();
    }

    /*
    private void print_type() throws java.rmi.RemoteException {
    ...
    */
     ...
     */
    public final boolean getDeterminantSign() throws java.rmi.RemoteException {
     ...
     */
    public final void setAutoNormalize(boolean autoNormalize) throws java.rmi.RemoteException {
     ...
     */
    public final boolean getAutoNormalize() throws java.rmi.RemoteException {
     ...
     */
    public final void setIdentity() throws java.rmi.RemoteException {
	wrapped.setIdentity();
    }
   ...
   /** 
     ...
     */
    public final void setZero() throws java.rmi.RemoteException {
	wrapped.setZero();
    }
   ...
   /**
     ...
     */
    public final void add(Transform3DRemote t1) throws java.rmi.RemoteException {
	wrapped.add( ((Transform3D)t1).getWrapped() );
    }
     ...
     */
    public final void add(Transform3DRemote t1, Transform3DRemote t2) throws java.rmi.RemoteException {
	wrapped.add( ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    }
     ...
     */
    public final void sub(Transform3DRemote t1) throws java.rmi.RemoteException {
        wrapped.sub( ((Transform3D)t1).getWrapped() );
    }
     ...
     */
    public final void sub(Transform3DRemote t1, Transform3DRemote t2) throws java.rmi.RemoteException {
	wrapped.sub( ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    } 
   ...
   /**
     ...
     */
    public final void transpose() throws java.rmi.RemoteException {
        wrapped.transpose();
    }
     ...
     */ 
    public final void transpose(Transform3DRemote t1) throws java.rmi.RemoteException {
        wrapped.transpose( ((Transform3D)t1).getWrapped() );
    }
   ...
   /**
     ...
     */ 
    public final void set(Quat4f q1) throws java.rmi.RemoteException {
        wrapped.set( q1 );
    }
   ...
   /**
     ...
     */
     public final void setRotation(Matrix3f m1) throws java.rmi.RemoteException {
    ...
    */
    public final void setRotation(Quat4f q1) throws java.rmi.RemoteException {
     ...
     */  
    public final void set(AxisAngle4f a1) throws java.rmi.RemoteException {
        wrapped.set( a1 );
    }
   ...
   /**
     ...
     */
    public final void set(Vector3f trans) throws java.rmi.RemoteException {
        wrapped.set( trans );
    }
     ...
     * @since WSG
     */
    public final void setScale(float scale) throws java.rmi.RemoteException {
     ...
     * @since WSG
     */
     public final void setScale(Vector3f scale) throws java.rmi.RemoteException {
       wrapped.setScale( scale );
     }
     ...
     * @param trans  the translational component
     */
    public final void setTranslation(Vector3f trans) throws java.rmi.RemoteException {
     ...
     */  
    public final void set(Quat4f q1, Vector3f t1, float s) throws java.rmi.RemoteException {
        wrapped.set( q1, t1, s );
    }
     ...
     * @param s the scale value
     */
    public final void set(Matrix3f m1, Vector3f t1, float s) throws java.rmi.RemoteException {  
	wrapped.set( m1, t1, s );
    }
     ...
     */  
    public final void set(Transform3DRemote t1) throws java.rmi.RemoteException {
        wrapped.set( ((Transform3D)t1).getWrapped() );
    }
   ...
   /**
     ...
     */
    public final void set(float[] matrix) throws java.rmi.RemoteException {
        wrapped.set( matrix );
    }
     ...
     */  
    public final void set(Matrix4f m1) throws java.rmi.RemoteException {
        wrapped.set( m1 );
    }
     ...
     * @param m1   the single precision 3x3 matrix 
     */   
    public final void set(Matrix3f m1) throws java.rmi.RemoteException {
        wrapped.set( m1 );
    }
     ...
     */  
    public final void get(float[] matrix) throws java.rmi.RemoteException {
        wrapped.get( matrix );
    }
     ...
     */  
    public final void get(Matrix3f m1) throws java.rmi.RemoteException {
        wrapped.get( m1 );
    }
     ...
     */
    public final void get(Quat4f q1) throws java.rmi.RemoteException {
        wrapped.get( q1 );
    } 
     ...
     */  
    public final void get(Matrix4f matrix) throws java.rmi.RemoteException {
	wrapped.get( matrix );
    }
   ...
   /**   
     ...
     */ 
    public final float get(Quat4f q1, Vector3f t1) throws java.rmi.RemoteException {  
     ...
     * @return  the scale component of this transform
     */  
    public final float get(Matrix3f m1, Vector3f t1) throws java.rmi.RemoteException {    
     ...
     */
    public final double getScale() throws java.rmi.RemoteException {
     ...
     */
    public final void get(Vector3f trans) throws java.rmi.RemoteException {
	wrapped.get( trans );
    }
     ...
     * not invertible
     */
    public final void invert(Transform3DRemote t1) throws java.rmi.RemoteException {
	wrapped.invert( ((Transform3D)t1).getWrapped() );
    }
     ...
     * not invertible
     */
    public final void invert() throws java.rmi.RemoteException {
	wrapped.invert();
    }
     ...
     */
     public final double determinant() throws java.rmi.RemoteException {
     ...
     */ 
    public final void set(Vector3f v1, float scale) throws java.rmi.RemoteException {
   ...
   /**
     ...
     */
    public final void mul(double scalar) throws java.rmi.RemoteException {
	wrapped.mul( scalar );
    }
   ...
   /**
     ...
     */
    public final void mul(double scalar, Transform3DRemote t1) throws java.rmi.RemoteException  {
	wrapped.mul( scalar, ((Transform3D)t1).getWrapped() );
    }
     ...
     */ 
    public final void mul(Transform3DRemote t1) throws java.rmi.RemoteException {
	wrapped.mul( ((Transform3D)t1).getWrapped() );
    } 
     ...
     * @param t2  the right transform
     */  
    public final void mul(Transform3DRemote t1, Transform3DRemote t2)throws java.rmi.RemoteException 
    {
	wrapped.mul( ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    } 
     ...
     */
    public final void mulInverse(Transform3DRemote t1) throws java.rmi.RemoteException {
	wrapped.mulInverse( ((Transform3D)t1).getWrapped() );
    } 
     ...
     */ 
    public final void mulInverse(Transform3DRemote t1, Transform3DRemote t2) throws java.rmi.RemoteException {
        wrapped.mulInverse( ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    } 
     ...
     */  
    public final void mulTransposeRight(Transform3DRemote t1, Transform3DRemote t2) throws java.rmi.RemoteException {
	wrapped.mulTransposeRight( ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    }
     ...
     */  
    public final void mulTransposeLeft(Transform3DRemote t1, Transform3DRemote t2) throws java.rmi.RemoteException {
        wrapped.mulTransposeLeft( ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    }
     ...
     * @param t2  the transform on the right hand side of the multiplication  
     */  
    public final void mulTransposeBoth(Transform3DRemote t1, Transform3DRemote t2) throws java.rmi.RemoteException {  
	wrapped.mulTransposeBoth( ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    }
     ...
     */
    public final void normalize() throws java.rmi.RemoteException {  
        wrapped.normalize();
    }
     ...
     */ 
    public final void normalize(Transform3DRemote t1) throws java.rmi.RemoteException {
	wrapped.normalize( ((Transform3D)t1).getWrapped() );
    }
     ...
     * Note that the scale of the matrix is not altered by this method.
     */ 
    public final void normalizeCP() throws java.rmi.RemoteException {
	wrapped.normalizeCP();
    }
     ...
     */ 
    public final void normalizeCP(Transform3DRemote t1) throws java.rmi.RemoteException {  
	wrapped.normalizeCP( ((Transform3D)t1).getWrapped() );
    }
    ...
    public boolean epsilonEquals(Transform3DRemote t1, double epsilon) throws java.rmi.RemoteException {
        return wrapped.epsilonEquals( ((Transform3D)t1).getWrapped(), epsilon );
    }
     ...
     * @param vec  the single precision vector to be transformed 
     */ 
    public final void transform(Vector4f vec) throws java.rmi.RemoteException {
     ...
     * @param point  the input point to be transformed
     */
    public final void transform(Point3f point) throws java.rmi.RemoteException { 
     ...
     */
    public final void transform(Vector3f normal, Vector3f normalOut) throws java.rmi.RemoteException {
     ...
     * @param normal   the input normal to be transformed
     */
    public final void transform(Vector3f normal) throws java.rmi.RemoteException { 
     ...
     */
    public final void setRotationScale(Matrix3f m1) throws java.rmi.RemoteException {
     ...
     *  @param t2 the transform to be added
     */
    public final void scaleAdd(double s, Transform3DRemote t1, Transform3DRemote t2) throws java.rmi.RemoteException {
	wrapped.scaleAdd( s, ((Transform3D)t1).getWrapped(), ((Transform3D)t2).getWrapped() );
    }
     ...
     *  @param t1 the transform to be added
     */
    public final void scaleAdd(double s, Transform3DRemote t1) throws java.rmi.RemoteException {
	wrapped.scaleAdd( s, ((Transform3D)t1).getWrapped() );
   }
     ...
     */
    public final void getRotationScale(Matrix3f m1) throws java.rmi.RemoteException {
    ...
    public org.jdesktop.lg3d.sg.Transform3D getWrapped() throws java.rmi.RemoteException {
        return wrapped;
    }
