/*
 * $RCSfile: ShaderAttributeObjectWrapper.java,v $
 *
...
/**
 * The ShaderAttributeObjectWrapper class is an abstract class that
 ...
 * ShaderAttributeObjectWrapper is constructed.  Subsequent setValue
 * operations must be called with an object of the same type as the
 * one that was used to construct the ShaderAttributeObjectWrapper. Finally,
...
public interface ShaderAttributeObjectWrapper extends ShaderAttributeWrapper {
