...
public class TransparencyAttributes extends NodeComponent {
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"TransparencyAttributes");
    ...
    public void setTransparencyMode(int transparencyMode) {
        ((TransparencyAttributesWrapper)wrapped).setTransparencyMode(transparencyMode);
    }
	...
	return ((TransparencyAttributesWrapper)wrapped).getTransparencyMode();
    }
    ...
    public void setTransparency(float transparency) {
        ((TransparencyAttributesWrapper)wrapped).setTransparency(transparency);
    }
	...
	return ((TransparencyAttributesWrapper)wrapped).getTransparency();
    }
    ...
    public void setSrcBlendFunction(int blendFunction) {
        ((TransparencyAttributesWrapper)wrapped).setSrcBlendFunction(blendFunction);
    }
	...
	return ((TransparencyAttributesWrapper)wrapped).getSrcBlendFunction();
    }
    ...
    public void setDstBlendFunction(int blendFunction) {
        ((TransparencyAttributesWrapper)wrapped).setDstBlendFunction(blendFunction);
    }
	...
	return ((TransparencyAttributesWrapper)wrapped).getDstBlendFunction();
    }
