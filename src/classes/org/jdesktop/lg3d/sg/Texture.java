...
public abstract class Texture extends NodeComponent {
	...
	((TextureWrapper)wrapped).setBoundaryModeS( boundaryModeS );
    }
	...
	return ((TextureWrapper)wrapped).getBoundaryModeS();
    }
	...
	((TextureWrapper)wrapped).setBoundaryModeT( boundaryModeT );
    }
	...
	return ((TextureWrapper)wrapped).getBoundaryModeT();
    }
	...
	((TextureWrapper)wrapped).setMinFilter( minFilter );
    }
	...
	return ((TextureWrapper)wrapped).getMinFilter();
    }
	...
	((TextureWrapper)wrapped).setMagFilter( magFilter );
    }
	...
	return ((TextureWrapper)wrapped).getMagFilter();
    }
    ...
    public void setImage(int level, ImageComponent image) {
        if (image==null)
            ((TextureWrapper)wrapped).setImage( level, null );
        else
            ((TextureWrapper)wrapped).setImage( level, (ImageComponentWrapper)image.wrapped );
    }
	...
	ImageComponentWrapper j3dIC = ((TextureWrapper)wrapped).getImage( level );
...
//        ImageComponentWrapper[] j3dImages = new ImageComponent[images.length];
//        
//        for(int i=0; i<images.length; i++)
//            j3dImages[i] = (javax.media.j3d.ImageComponent)images[i].wrapped;
//        
//	((TextureWrapper)wrapped).setImages( j3dImages );
...
//        javax.media.j3d.ImageComponent[] j3dImages = ((TextureWrapper)wrapped).getImages();
...
//        throw new RuntimeException("Not Implemented");
	...
	return ((TextureWrapper)wrapped).getFormat();
    }
     ...
     */
    public int getWidth() {
	return ((TextureWrapper)wrapped).getWidth();
    }
	...
	return ((TextureWrapper)wrapped).getHeight();
    }
	...
	return ((TextureWrapper)wrapped).getBoundaryWidth();
    }
	...
	return ((TextureWrapper)wrapped).numMipMapLevels();
    }
	...
	((TextureWrapper)wrapped).setMipMapMode(mipMapMode);
    }
	...
	return ((TextureWrapper)wrapped).getMipMapMode();
    }
	...
	((TextureWrapper)wrapped).setEnable(state);
    }
	...
	return ((TextureWrapper)wrapped).getEnable();
    }
	...
	((TextureWrapper)wrapped).setBoundaryColor(boundaryColor);
    }
	...
	((TextureWrapper)wrapped).setBoundaryColor( r,g,b,a );
    }
	...
	((TextureWrapper)wrapped).getBoundaryColor(boundaryColor);
    }
	...
	((TextureWrapper)wrapped).setBaseLevel(baseLevel);
    }
    ...
    public int getBaseLevel() {
        return ((TextureWrapper)wrapped).getBaseLevel();
    }
	...
	((TextureWrapper)wrapped).setMaximumLevel(maximumLevel);
    }
    ...
    public int getMaximumLevel() {
        return ((TextureWrapper)wrapped).getMaximumLevel();
    }
	...
	((TextureWrapper)wrapped).setMinimumLOD(minimumLod);
    }
    ...
    public float getMinimumLOD() {
        return ((TextureWrapper)wrapped).getMinimumLOD();
    }
	...
	((TextureWrapper)wrapped).setMaximumLOD(maximumLod);
    }
    ...
    public float getMaximumLOD() {
        return ((TextureWrapper)wrapped).getMaximumLOD();
    }
	...
	((TextureWrapper)wrapped).setLodOffset( s,t,r );
    }
	...
	((TextureWrapper)wrapped).setLodOffset( offset );
    }
    ...
    public void getLodOffset(Tuple3f offset) {
        ((TextureWrapper)wrapped).getLodOffset(offset);
    }
	...
	((TextureWrapper)wrapped).setAnisotropicFilterMode( mode );
    }
    ...
    public int getAnisotropicFilterMode() {
        return ((TextureWrapper)wrapped).getAnisotropicFilterMode();
    }
	...
	((TextureWrapper)wrapped).setAnisotropicFilterDegree( degree );
    }
    ...
    public float getAnisotropicFilterDegree() {
        return ((TextureWrapper)wrapped).getAnisotropicFilterDegree();
    }
	...
	((TextureWrapper)wrapped).setSharpenTextureFunc( lod, pts );
    }
	...
	((TextureWrapper)wrapped).setSharpenTextureFunc( pts );
    }
    ...
    public int getSharpenTextureFuncPointsCount() {
        return ((TextureWrapper)wrapped).getSharpenTextureFuncPointsCount();
    }
    ...
    public void getSharpenTextureFunc(float[] lod, float[] pts) {
        ((TextureWrapper)wrapped).getSharpenTextureFunc( lod,pts);
    }
    ...
    public void getSharpenTextureFunc(Point2f[] pts) {
        ((TextureWrapper)wrapped).getSharpenTextureFunc(pts);
    }
	...
	((TextureWrapper)wrapped).setFilter4Func( weights );
    }
    ...
    public int getFilter4FuncPointsCount() {
        return ((TextureWrapper)wrapped).getFilter4FuncPointsCount();
    }
    ...
    public void getFilter4Func(float[] weights) {
        ((TextureWrapper)wrapped).getFilter4Func( weights );
    }
