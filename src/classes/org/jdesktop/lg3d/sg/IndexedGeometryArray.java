...
public abstract class IndexedGeometryArray extends GeometryArray {
  ...
  public static final int
    ...
    */
    public int getIndexCount(){
        return ((IndexedGeometryArrayWrapper)wrapped).getIndexCount();
    }
    ...
    public void setValidIndexCount(int validIndexCount) {
        ((IndexedGeometryArrayWrapper)wrapped).setValidIndexCount(validIndexCount);
    }
    ...
    public int getValidIndexCount() {
        return ((IndexedGeometryArrayWrapper)wrapped).getValidIndexCount();
    }
    ...
    public void setInitialIndexIndex(int initialIndexIndex) {
        ((IndexedGeometryArrayWrapper)wrapped).setInitialIndexIndex(initialIndexIndex);
    }
    ...
    public int getInitialIndexIndex() {
        return ((IndexedGeometryArrayWrapper)wrapped).getInitialIndexIndex();
    }
  ...
  public void setCoordinateIndex(int index, int coordinateIndex) {
        ((IndexedGeometryArrayWrapper)wrapped).setCoordinateIndex( index, coordinateIndex );
  }
  ...
  public void setCoordinateIndices(int index, int coordinateIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).setCoordinateIndices( index, coordinateIndices );
  }
  ...
  public void setColorIndex(int index, int colorIndex) {
        ((IndexedGeometryArrayWrapper)wrapped).setColorIndex( index, colorIndex );
  }
  ...
  public void setColorIndices(int index, int colorIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).setColorIndices( index, colorIndices );
  }
  ...
  public void setNormalIndex(int index, int normalIndex) {
        ((IndexedGeometryArrayWrapper)wrapped).setNormalIndex( index, normalIndex );
  }
  ...
  public void setNormalIndices(int index, int normalIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).setNormalIndices( index, normalIndices );
  }
    ...
    public void setTextureCoordinateIndex(int texCoordSet,
					  int index,
					  int texCoordIndex) {
        ((IndexedGeometryArrayWrapper)wrapped).setTextureCoordinateIndex( texCoordSet,
					   index,
					   texCoordIndex );
    }
    ...
    public void setTextureCoordinateIndices(int texCoordSet,
					    int index,
					    int texCoordIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).setTextureCoordinateIndices( texCoordSet,
					     index,
					     texCoordIndices );
    }
  ...
  public int getCoordinateIndex(int index) {
        return ((IndexedGeometryArrayWrapper)wrapped).getCoordinateIndex( index );
  }
  ...
  public void getCoordinateIndices(int index, int coordinateIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).getCoordinateIndices( index, coordinateIndices );
  }
  ...
  public int getColorIndex(int index) {
        return ((IndexedGeometryArrayWrapper)wrapped).getColorIndex( index );
  }
  ...
  public void getColorIndices(int index, int colorIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).getColorIndices( index, colorIndices );
  }
  ...
  public int getNormalIndex(int index) {
        return ((IndexedGeometryArrayWrapper)wrapped).getNormalIndex( index );
  }
  ...
  public void getNormalIndices(int index, int normalIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).getNormalIndices( index, normalIndices );
  }
    ...
    public int getTextureCoordinateIndex(int texCoordSet, int index) {
        return ((IndexedGeometryArrayWrapper)wrapped).getTextureCoordinateIndex( texCoordSet, index );
    }
    ...
    public void getTextureCoordinateIndices(int texCoordSet,
					    int index,
					    int texCoordIndices[]) {
        ((IndexedGeometryArrayWrapper)wrapped).getTextureCoordinateIndices( texCoordSet,
					     index,
					     texCoordIndices );
    }
