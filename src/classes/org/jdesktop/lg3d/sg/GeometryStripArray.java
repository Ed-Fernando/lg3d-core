...
public abstract class GeometryStripArray extends GeometryArray {
	...
	return ((GeometryStripArrayWrapper)wrapped).getNumStrips();
    }
	...
	((GeometryStripArrayWrapper)wrapped).setStripVertexCounts(stripVertexCounts);
    }
	...
	((GeometryStripArrayWrapper)wrapped).getStripVertexCounts(stripVertexCounts);
    }
