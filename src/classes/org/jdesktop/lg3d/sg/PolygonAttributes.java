...
public class PolygonAttributes extends NodeComponent {
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"PolygonAttributes");
    }
    ...
    public void setCullFace(int cullFace) {
        ((PolygonAttributesWrapper)wrapped).setCullFace(cullFace);
    }
    ...
    public int getCullFace() {
        return ((PolygonAttributesWrapper)wrapped).getCullFace();
    }
    ...
    public void setBackFaceNormalFlip(boolean backFaceNormalFlip) {
        ((PolygonAttributesWrapper)wrapped).setBackFaceNormalFlip(backFaceNormalFlip);
    }
    ...
    public boolean getBackFaceNormalFlip() {
        return ((PolygonAttributesWrapper)wrapped).getBackFaceNormalFlip();
    }
    ...
    public void setPolygonMode(int polygonMode) {
        ((PolygonAttributesWrapper)wrapped).setPolygonMode(polygonMode);
    }
    ...
    public int getPolygonMode() {
        return ((PolygonAttributesWrapper)wrapped).getPolygonMode();
    }
    ...
    public void setPolygonOffset(float polygonOffset) {
        ((PolygonAttributesWrapper)wrapped).setPolygonOffset(polygonOffset);
    }
    ...
    public float getPolygonOffset() {
        return ((PolygonAttributesWrapper)wrapped).getPolygonOffset();
    }
    ...
    public void setPolygonOffsetFactor(float polygonOffsetFactor) {
        ((PolygonAttributesWrapper)wrapped).setPolygonOffsetFactor(polygonOffsetFactor);
    }
    ...
    public float getPolygonOffsetFactor() {
        return ((PolygonAttributesWrapper)wrapped).getPolygonOffsetFactor();
    }
