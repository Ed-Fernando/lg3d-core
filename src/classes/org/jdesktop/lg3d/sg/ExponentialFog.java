...
public class ExponentialFog extends Fog {
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"ExponentialFog");    
    }
    ...
    public void setDensity(float density) {
        ((ExponentialFogWrapper)wrapped).setDensity(density);
    }
    ...
    public float getDensity() {
        return ((ExponentialFogWrapper)wrapped).getDensity();
    }
