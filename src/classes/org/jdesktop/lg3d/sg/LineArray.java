...
public class LineArray extends GeometryArray {
    ...
    public LineArray(int vertexCount, int vertexFormat) {
        ...
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"LineArray", new Class[] {Integer.TYPE, Integer.TYPE}, new Object[] { new Integer(vertexCount), new Integer( vertexFormat ) } );
    }
    ...
    public LineArray(int vertexCount,
			 ...
			 int[] texCoordSetMap) {
        assert(this.getClass()==LineArray.class);
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"LineArray",
