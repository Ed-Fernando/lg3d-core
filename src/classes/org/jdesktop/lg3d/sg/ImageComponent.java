...
public abstract class ImageComponent extends NodeComponent {
  ...
  // Change this if any more formats are added or removed
     ...
     */  
    public int getWidth() {
        return ((ImageComponentWrapper)wrapped).getWidth();
    }
    ...
    public int getHeight() {
        return ((ImageComponentWrapper)wrapped).getHeight();
    }
    ...
    public int getFormat() {
        return ((ImageComponentWrapper)wrapped).getFormat();
    }
    ...
    public boolean isByReference() {
        return ((ImageComponentWrapper)wrapped).isByReference();
    }
    ...
    public void setYUp(boolean yUp) {
        ((ImageComponentWrapper)wrapped).setYUp( yUp );
    }
    ...
    public boolean isYUp() {
        return ((ImageComponentWrapper)wrapped).isYUp();
    }
