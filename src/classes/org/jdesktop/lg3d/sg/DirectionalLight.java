  ...
  */
  ...
  public static final int
    ...
    protected void createWrapped() {
        wrapped = instantiate( SceneGraphSetup.getWrapperPackage()+"DirectionalLight");
    }
   ...
   */
    public void setDirection(Vector3f direction) {
        ((DirectionalLightWrapper)wrapped).setDirection( direction );
    }
   ...
   */
    public void setDirection(float x, float y, float z) {
        ((DirectionalLightWrapper)wrapped).setDirection( x,y,z );
  }
   ...
   */
    public void getDirection(Vector3f direction) {
        ((DirectionalLightWrapper)wrapped).getDirection( direction );
    }
