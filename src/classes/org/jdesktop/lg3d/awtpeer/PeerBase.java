...
public abstract class PeerBase extends Frame3D implements PeerInterface {
...
//        System.err.println(" Height3D "+height3D);
    ...
    public void changeTranslation(float x, float y, float z, int duration) {
        ...
        //logger.warning("Swing "+swingX+", "+swingY+"  "+(toolkit3d.widthNativeToPhysical(swingX-swingOriginOffsetX)+width3D/2)+"  "+(toolkit3d.heightNativeToPhysical(swingOriginOffsetY-swingY)-height3D/2));
         ...
         comp.addListener(
            new LgEventListener() {
                public void processEvent(LgEvent evt) {
                    ...
                    //logger.severe("PeerBase processEvent "+evt);
