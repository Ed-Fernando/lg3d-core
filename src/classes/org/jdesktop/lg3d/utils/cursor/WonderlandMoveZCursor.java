 ...
 *
 * $RCSfile: WonderlandMoveZCursor.java,v $
 *
...
public class WonderlandMoveZCursor extends Cursor3D {
    /**
     * Note - this method uses a naming convention to decide rotation angle
     * of the cursor shape.
     */
    public WonderlandMoveZCursor(String name, float size) {
	/*
	this(name, size, 
	...
	*/
    ...
    public WonderlandMoveZCursor(String name, float size, float dir) {
        super(name);
	...
	float arrowHeight = size * 0.4f * 4f;
