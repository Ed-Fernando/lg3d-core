 ...
 *
 * $RCSfile: Component3DToFrontEventAdapter.java,v $
 *
...
/**
 * Event adapter for Component3DToFrontEvent.
 */
public class Component3DToFrontEventAdapter implements EventAdapter {
    private static final Class[] targetEventClasses = {
        Component3DToFrontEvent.class
    };
     ...
     */
    public Component3DToFrontEventAdapter(ActionComponent3D action) {
    ...
    public void processEvent(LgEvent event) {
        assert(event instanceof Component3DToFrontEvent);
        assert(action != null);
        
        LgEventSource source = event.getSource();
        Component3DToFrontEvent cfe = (Component3DToFrontEvent)event;
        Component3D sibling = cfe.getSibling();
