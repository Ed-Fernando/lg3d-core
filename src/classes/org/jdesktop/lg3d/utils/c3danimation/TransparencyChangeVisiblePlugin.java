 ...
 *
 * $RCSfile: TransparencyChangeVisiblePlugin.java,v $
 *
 ...
 *
 */
public class TransparencyChangeVisiblePlugin implements ChangeVisibleAnimationPlugin {
    private PluggableC3DAnimation anim;
    private int defaultDuration;
    private ConcurrentTimedSubAnimationHelper.SubAnimation animItem;
    private boolean visible;
    
    public TransparencyChangeVisiblePlugin(int duration) {
    ...
    public void changeVisible(boolean visible, int duration) {
        ...
        if (visible) {
            ...
            // Fully opaque
            anim.changeTransparency(0.0f, duration);
        } else {
            // Fully transparent
            anim.changeTransparency(1.0f, duration);
        }
