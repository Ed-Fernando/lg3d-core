 ...
 *
 * $RCSfile: ScaleChangeVisiblePlugin.java,v $
 *
 ...
 *
 */
public class ScaleChangeVisiblePlugin implements ChangeVisibleAnimationPlugin {
    private PluggableC3DAnimation anim;
    private int defaultDuration;
    private ConcurrentTimedSubAnimationHelper.SubAnimation animItem;
    private boolean visible;
    
    public ScaleChangeVisiblePlugin(int duration) {
