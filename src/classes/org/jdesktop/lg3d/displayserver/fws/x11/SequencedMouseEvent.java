 ...
 *
 * $RCSfile: SequencedMouseEvent.java,v $
 *
...
public class SequencedMouseEvent extends MouseEvent {
    ...
    public static void setWsx (WinSysX11 wsx) { SequencedMouseEvent.wsx = wsx; }
    public static WinSysX11 getWsx () { return wsx; }

    public SequencedMouseEvent (Canvas3D canvas, long rootWid, long wid, int type, 
				long when, int modifiers, int x, int y, int clickCount, 
				boolean popupTrigger) {
	super(canvas, type, when, modifiers, x, y, clickCount, popupTrigger);
